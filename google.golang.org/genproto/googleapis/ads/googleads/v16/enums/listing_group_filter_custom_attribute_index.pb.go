...
// 	protoc        v5.26.1
// source: listing_group_filter_custom_attribute_index.proto
...
func (ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex) Descriptor() protoreflect.EnumDescriptor {
	return file_listing_group_filter_custom_attribute_index_proto_enumTypes[0].Descriptor()
}

func (ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex) Type() protoreflect.EnumType {
	return &file_listing_group_filter_custom_attribute_index_proto_enumTypes[0]
}
...
func (ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex) EnumDescriptor() ([]byte, []int) {
	return file_listing_group_filter_custom_attribute_index_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ListingGroupFilterCustomAttributeIndexEnum) Reset() {
	*x = ListingGroupFilterCustomAttributeIndexEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_listing_group_filter_custom_attribute_index_proto_msgTypes[0]
...
func (*ListingGroupFilterCustomAttributeIndexEnum) Descriptor() ([]byte, []int) {
	return file_listing_group_filter_custom_attribute_index_proto_rawDescGZIP(), []int{0}
}

var File_listing_group_filter_custom_attribute_index_proto protoreflect.FileDescriptor

var file_listing_group_filter_custom_attribute_index_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x0f, 0x0a,
	0x0b, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0b,
	0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x49,
	0x4e, 0x44, 0x45, 0x58, 0x30, 0x10, 0x02, 0x12, 0x0a, 0x0a, 0x06, 0x49, 0x4e, 0x44, 0x45, 0x58,
	0x31, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x49, 0x4e, 0x44, 0x45, 0x58, 0x32, 0x10, 0x04, 0x12,
	0x0a, 0x0a, 0x06, 0x49, 0x4e, 0x44, 0x45, 0x58, 0x33, 0x10, 0x05, 0x12, 0x0a, 0x0a, 0x06, 0x49,
	0x4e, 0x44, 0x45, 0x58, 0x34, 0x10, 0x06, 0x42, 0x85, 0x02, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x65, 0x72, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74,
...
var (
	file_listing_group_filter_custom_attribute_index_proto_rawDescOnce sync.Once
	file_listing_group_filter_custom_attribute_index_proto_rawDescData = file_listing_group_filter_custom_attribute_index_proto_rawDesc
)

func file_listing_group_filter_custom_attribute_index_proto_rawDescGZIP() []byte {
	file_listing_group_filter_custom_attribute_index_proto_rawDescOnce.Do(func() {
		file_listing_group_filter_custom_attribute_index_proto_rawDescData = protoimpl.X.CompressGZIP(file_listing_group_filter_custom_attribute_index_proto_rawDescData)
	})
	return file_listing_group_filter_custom_attribute_index_proto_rawDescData
}

var file_listing_group_filter_custom_attribute_index_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_listing_group_filter_custom_attribute_index_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_listing_group_filter_custom_attribute_index_proto_goTypes = []interface{}{
...
var file_listing_group_filter_custom_attribute_index_proto_depIdxs = []int32{
...
func init() { file_listing_group_filter_custom_attribute_index_proto_init() }
func file_listing_group_filter_custom_attribute_index_proto_init() {
	if File_listing_group_filter_custom_attribute_index_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_listing_group_filter_custom_attribute_index_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_listing_group_filter_custom_attribute_index_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_listing_group_filter_custom_attribute_index_proto_goTypes,
		DependencyIndexes: file_listing_group_filter_custom_attribute_index_proto_depIdxs,
		EnumInfos:         file_listing_group_filter_custom_attribute_index_proto_enumTypes,
		MessageInfos:      file_listing_group_filter_custom_attribute_index_proto_msgTypes,
	}.Build()
	File_listing_group_filter_custom_attribute_index_proto = out.File
	file_listing_group_filter_custom_attribute_index_proto_rawDesc = nil
	file_listing_group_filter_custom_attribute_index_proto_goTypes = nil
	file_listing_group_filter_custom_attribute_index_proto_depIdxs = nil
}
