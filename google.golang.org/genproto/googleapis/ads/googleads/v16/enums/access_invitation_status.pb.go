...
// 	protoc        v5.26.1
// source: access_invitation_status.proto
...
func (AccessInvitationStatusEnum_AccessInvitationStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_access_invitation_status_proto_enumTypes[0].Descriptor()
}

func (AccessInvitationStatusEnum_AccessInvitationStatus) Type() protoreflect.EnumType {
	return &file_access_invitation_status_proto_enumTypes[0]
}
...
func (AccessInvitationStatusEnum_AccessInvitationStatus) EnumDescriptor() ([]byte, []int) {
	return file_access_invitation_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AccessInvitationStatusEnum) Reset() {
	*x = AccessInvitationStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_access_invitation_status_proto_msgTypes[0]
...
func (*AccessInvitationStatusEnum) Descriptor() ([]byte, []int) {
	return file_access_invitation_status_proto_rawDescGZIP(), []int{0}
}

var File_access_invitation_status_proto protoreflect.FileDescriptor

var file_access_invitation_status_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74,
	...
	0x22, 0x7c, 0x0a, 0x1a, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x5e,
	0x0a, 0x16, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69,
	...
	0x47, 0x10, 0x02, 0x12, 0x0c, 0x0a, 0x08, 0x44, 0x45, 0x43, 0x4c, 0x49, 0x4e, 0x45, 0x44, 0x10,
	0x03, 0x12, 0x0b, 0x0a, 0x07, 0x45, 0x58, 0x50, 0x49, 0x52, 0x45, 0x44, 0x10, 0x04, 0x42, 0xf5,
	...
	0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1b, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x49, 0x6e, 0x76,
	0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x50, 0x72, 0x6f,
...
var (
	file_access_invitation_status_proto_rawDescOnce sync.Once
	file_access_invitation_status_proto_rawDescData = file_access_invitation_status_proto_rawDesc
)

func file_access_invitation_status_proto_rawDescGZIP() []byte {
	file_access_invitation_status_proto_rawDescOnce.Do(func() {
		file_access_invitation_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_access_invitation_status_proto_rawDescData)
	})
	return file_access_invitation_status_proto_rawDescData
}

var file_access_invitation_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_access_invitation_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_access_invitation_status_proto_goTypes = []interface{}{
...
var file_access_invitation_status_proto_depIdxs = []int32{
...
func init() { file_access_invitation_status_proto_init() }
func file_access_invitation_status_proto_init() {
	if File_access_invitation_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_access_invitation_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_access_invitation_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_access_invitation_status_proto_goTypes,
		DependencyIndexes: file_access_invitation_status_proto_depIdxs,
		EnumInfos:         file_access_invitation_status_proto_enumTypes,
		MessageInfos:      file_access_invitation_status_proto_msgTypes,
	}.Build()
	File_access_invitation_status_proto = out.File
	file_access_invitation_status_proto_rawDesc = nil
	file_access_invitation_status_proto_goTypes = nil
	file_access_invitation_status_proto_depIdxs = nil
}
