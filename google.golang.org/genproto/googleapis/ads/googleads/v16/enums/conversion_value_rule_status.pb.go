...
// 	protoc        v5.26.1
// source: conversion_value_rule_status.proto
...
func (ConversionValueRuleStatusEnum_ConversionValueRuleStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_conversion_value_rule_status_proto_enumTypes[0].Descriptor()
}

func (ConversionValueRuleStatusEnum_ConversionValueRuleStatus) Type() protoreflect.EnumType {
	return &file_conversion_value_rule_status_proto_enumTypes[0]
}
...
func (ConversionValueRuleStatusEnum_ConversionValueRuleStatus) EnumDescriptor() ([]byte, []int) {
	return file_conversion_value_rule_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConversionValueRuleStatusEnum) Reset() {
	*x = ConversionValueRuleStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_conversion_value_rule_status_proto_msgTypes[0]
...
func (*ConversionValueRuleStatusEnum) Descriptor() ([]byte, []int) {
	return file_conversion_value_rule_status_proto_rawDescGZIP(), []int{0}
}

var File_conversion_value_rule_status_proto protoreflect.FileDescriptor

var file_conversion_value_rule_status_proto_rawDesc = []byte{
	0x0a, 0x22, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x76, 0x61, 0x6c,
	...
	0x6e, 0x75, 0x6d, 0x73, 0x22, 0x80, 0x01, 0x0a, 0x1d, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x75, 0x6c, 0x65, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x5f, 0x0a, 0x19, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72,
	...
	0x0a, 0x07, 0x52, 0x45, 0x4d, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x50,
	0x41, 0x55, 0x53, 0x45, 0x44, 0x10, 0x04, 0x42, 0xf8, 0x01, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x75, 0x6c, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var (
	file_conversion_value_rule_status_proto_rawDescOnce sync.Once
	file_conversion_value_rule_status_proto_rawDescData = file_conversion_value_rule_status_proto_rawDesc
)

func file_conversion_value_rule_status_proto_rawDescGZIP() []byte {
	file_conversion_value_rule_status_proto_rawDescOnce.Do(func() {
		file_conversion_value_rule_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_conversion_value_rule_status_proto_rawDescData)
	})
	return file_conversion_value_rule_status_proto_rawDescData
}

var file_conversion_value_rule_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_conversion_value_rule_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_conversion_value_rule_status_proto_goTypes = []interface{}{
...
var file_conversion_value_rule_status_proto_depIdxs = []int32{
...
func init() { file_conversion_value_rule_status_proto_init() }
func file_conversion_value_rule_status_proto_init() {
	if File_conversion_value_rule_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_conversion_value_rule_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_conversion_value_rule_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_conversion_value_rule_status_proto_goTypes,
		DependencyIndexes: file_conversion_value_rule_status_proto_depIdxs,
		EnumInfos:         file_conversion_value_rule_status_proto_enumTypes,
		MessageInfos:      file_conversion_value_rule_status_proto_msgTypes,
	}.Build()
	File_conversion_value_rule_status_proto = out.File
	file_conversion_value_rule_status_proto_rawDesc = nil
	file_conversion_value_rule_status_proto_goTypes = nil
	file_conversion_value_rule_status_proto_depIdxs = nil
}
