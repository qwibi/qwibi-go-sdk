...
// 	protoc        v5.26.1
// source: feed_mapping_status.proto
...
func (FeedMappingStatusEnum_FeedMappingStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_feed_mapping_status_proto_enumTypes[0].Descriptor()
}

func (FeedMappingStatusEnum_FeedMappingStatus) Type() protoreflect.EnumType {
	return &file_feed_mapping_status_proto_enumTypes[0]
}
...
func (FeedMappingStatusEnum_FeedMappingStatus) EnumDescriptor() ([]byte, []int) {
	return file_feed_mapping_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *FeedMappingStatusEnum) Reset() {
	*x = FeedMappingStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_feed_mapping_status_proto_msgTypes[0]
...
func (*FeedMappingStatusEnum) Descriptor() ([]byte, []int) {
	return file_feed_mapping_status_proto_rawDescGZIP(), []int{0}
}

var File_feed_mapping_status_proto protoreflect.FileDescriptor

var file_feed_mapping_status_proto_rawDesc = []byte{
	0x0a, 0x19, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x5f, 0x73,
	...
	0x65, 0x65, 0x64, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x45, 0x6e, 0x75, 0x6d, 0x22, 0x4b, 0x0a, 0x11, 0x46, 0x65, 0x65, 0x64, 0x4d, 0x61, 0x70, 0x70,
	...
	0x31, 0x36, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x16, 0x46, 0x65, 0x65, 0x64, 0x4d, 0x61,
	0x70, 0x70, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_feed_mapping_status_proto_rawDescOnce sync.Once
	file_feed_mapping_status_proto_rawDescData = file_feed_mapping_status_proto_rawDesc
)

func file_feed_mapping_status_proto_rawDescGZIP() []byte {
	file_feed_mapping_status_proto_rawDescOnce.Do(func() {
		file_feed_mapping_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_feed_mapping_status_proto_rawDescData)
	})
	return file_feed_mapping_status_proto_rawDescData
}

var file_feed_mapping_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_feed_mapping_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_feed_mapping_status_proto_goTypes = []interface{}{
...
var file_feed_mapping_status_proto_depIdxs = []int32{
...
func init() { file_feed_mapping_status_proto_init() }
func file_feed_mapping_status_proto_init() {
	if File_feed_mapping_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_feed_mapping_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_feed_mapping_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_feed_mapping_status_proto_goTypes,
		DependencyIndexes: file_feed_mapping_status_proto_depIdxs,
		EnumInfos:         file_feed_mapping_status_proto_enumTypes,
		MessageInfos:      file_feed_mapping_status_proto_msgTypes,
	}.Build()
	File_feed_mapping_status_proto = out.File
	file_feed_mapping_status_proto_rawDesc = nil
	file_feed_mapping_status_proto_goTypes = nil
	file_feed_mapping_status_proto_depIdxs = nil
}
