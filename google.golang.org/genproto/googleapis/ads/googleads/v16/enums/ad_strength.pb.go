...
func (AdStrengthEnum_AdStrength) Descriptor() protoreflect.EnumDescriptor {
	return file_ad_strength_proto_enumTypes[0].Descriptor()
}

func (AdStrengthEnum_AdStrength) Type() protoreflect.EnumType {
	return &file_ad_strength_proto_enumTypes[0]
}
...
func (AdStrengthEnum_AdStrength) EnumDescriptor() ([]byte, []int) {
	return file_ad_strength_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AdStrengthEnum) Reset() {
	*x = AdStrengthEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ad_strength_proto_msgTypes[0]
...
func (*AdStrengthEnum) Descriptor() ([]byte, []int) {
	return file_ad_strength_proto_rawDescGZIP(), []int{0}
}

var File_ad_strength_proto protoreflect.FileDescriptor

var file_ad_strength_proto_rawDesc = []byte{
	0x0a, 0x11, 0x61, 0x64, 0x5f, 0x73, 0x74, 0x72, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x2e, 0x70, 0x72,
	...
	0x75, 0x6d, 0x73, 0x22, 0x85, 0x01, 0x0a, 0x0e, 0x41, 0x64, 0x53, 0x74, 0x72, 0x65, 0x6e, 0x67,
	0x74, 0x68, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x73, 0x0a, 0x0a, 0x41, 0x64, 0x53, 0x74, 0x72, 0x65,
	...
	0x0a, 0x0a, 0x06, 0x4e, 0x4f, 0x5f, 0x41, 0x44, 0x53, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x50,
	0x4f, 0x4f, 0x52, 0x10, 0x04, 0x12, 0x0b, 0x0a, 0x07, 0x41, 0x56, 0x45, 0x52, 0x41, 0x47, 0x45,
	0x10, 0x05, 0x12, 0x08, 0x0a, 0x04, 0x47, 0x4f, 0x4f, 0x44, 0x10, 0x06, 0x12, 0x0d, 0x0a, 0x09,
	0x45, 0x58, 0x43, 0x45, 0x4c, 0x4c, 0x45, 0x4e, 0x54, 0x10, 0x07, 0x42, 0xe9, 0x01, 0x0a, 0x22,
	...
	0x6d, 0x73, 0x42, 0x0f, 0x41, 0x64, 0x53, 0x74, 0x72, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x50, 0x72,
...
var (
	file_ad_strength_proto_rawDescOnce sync.Once
	file_ad_strength_proto_rawDescData = file_ad_strength_proto_rawDesc
)

func file_ad_strength_proto_rawDescGZIP() []byte {
	file_ad_strength_proto_rawDescOnce.Do(func() {
		file_ad_strength_proto_rawDescData = protoimpl.X.CompressGZIP(file_ad_strength_proto_rawDescData)
	})
	return file_ad_strength_proto_rawDescData
}

var file_ad_strength_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_ad_strength_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ad_strength_proto_goTypes = []interface{}{
...
var file_ad_strength_proto_depIdxs = []int32{
...
func init() { file_ad_strength_proto_init() }
func file_ad_strength_proto_init() {
	if File_ad_strength_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ad_strength_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ad_strength_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ad_strength_proto_goTypes,
		DependencyIndexes: file_ad_strength_proto_depIdxs,
		EnumInfos:         file_ad_strength_proto_enumTypes,
		MessageInfos:      file_ad_strength_proto_msgTypes,
	}.Build()
	File_ad_strength_proto = out.File
	file_ad_strength_proto_rawDesc = nil
	file_ad_strength_proto_goTypes = nil
	file_ad_strength_proto_depIdxs = nil
}
