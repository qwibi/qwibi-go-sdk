...
// 	protoc        v5.26.1
// source: change_status_operation.proto
...
func (ChangeStatusOperationEnum_ChangeStatusOperation) Descriptor() protoreflect.EnumDescriptor {
	return file_change_status_operation_proto_enumTypes[0].Descriptor()
}

func (ChangeStatusOperationEnum_ChangeStatusOperation) Type() protoreflect.EnumType {
	return &file_change_status_operation_proto_enumTypes[0]
}
...
func (ChangeStatusOperationEnum_ChangeStatusOperation) EnumDescriptor() ([]byte, []int) {
	return file_change_status_operation_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ChangeStatusOperationEnum) Reset() {
	*x = ChangeStatusOperationEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_change_status_operation_proto_msgTypes[0]
...
func (*ChangeStatusOperationEnum) Descriptor() ([]byte, []int) {
	return file_change_status_operation_proto_rawDescGZIP(), []int{0}
}

var File_change_status_operation_proto protoreflect.FileDescriptor

var file_change_status_operation_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f,
	...
	0x77, 0x0a, 0x19, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4f,
	0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x5a, 0x0a, 0x15,
	...
	0x4e, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x41, 0x44, 0x44, 0x45, 0x44, 0x10, 0x02, 0x12, 0x0b,
	0x0a, 0x07, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x44, 0x10, 0x03, 0x12, 0x0b, 0x0a, 0x07, 0x52,
	0x45, 0x4d, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x04, 0x42, 0xf4, 0x01, 0x0a, 0x22, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x36, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42,
	0x1a, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x43, 0x67,
...
var (
	file_change_status_operation_proto_rawDescOnce sync.Once
	file_change_status_operation_proto_rawDescData = file_change_status_operation_proto_rawDesc
)

func file_change_status_operation_proto_rawDescGZIP() []byte {
	file_change_status_operation_proto_rawDescOnce.Do(func() {
		file_change_status_operation_proto_rawDescData = protoimpl.X.CompressGZIP(file_change_status_operation_proto_rawDescData)
	})
	return file_change_status_operation_proto_rawDescData
}

var file_change_status_operation_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_change_status_operation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_change_status_operation_proto_goTypes = []interface{}{
...
var file_change_status_operation_proto_depIdxs = []int32{
...
func init() { file_change_status_operation_proto_init() }
func file_change_status_operation_proto_init() {
	if File_change_status_operation_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_change_status_operation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_change_status_operation_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_change_status_operation_proto_goTypes,
		DependencyIndexes: file_change_status_operation_proto_depIdxs,
		EnumInfos:         file_change_status_operation_proto_enumTypes,
		MessageInfos:      file_change_status_operation_proto_msgTypes,
	}.Build()
	File_change_status_operation_proto = out.File
	file_change_status_operation_proto_rawDesc = nil
	file_change_status_operation_proto_goTypes = nil
	file_change_status_operation_proto_depIdxs = nil
}
