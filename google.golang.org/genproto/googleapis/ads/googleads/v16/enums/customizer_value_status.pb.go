...
// 	protoc        v5.26.1
// source: customizer_value_status.proto
...
func (CustomizerValueStatusEnum_CustomizerValueStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_customizer_value_status_proto_enumTypes[0].Descriptor()
}

func (CustomizerValueStatusEnum_CustomizerValueStatus) Type() protoreflect.EnumType {
	return &file_customizer_value_status_proto_enumTypes[0]
}
...
func (CustomizerValueStatusEnum_CustomizerValueStatus) EnumDescriptor() ([]byte, []int) {
	return file_customizer_value_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CustomizerValueStatusEnum) Reset() {
	*x = CustomizerValueStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_customizer_value_status_proto_msgTypes[0]
...
func (*CustomizerValueStatusEnum) Descriptor() ([]byte, []int) {
	return file_customizer_value_status_proto_rawDescGZIP(), []int{0}
}

var File_customizer_value_status_proto protoreflect.FileDescriptor

var file_customizer_value_status_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65, 0x72, 0x5f, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x6c, 0x0a, 0x19, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65, 0x72, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x4f, 0x0a, 0x15,
	...
	0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x4d, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x03, 0x42, 0xf4, 0x01,
	...
	0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1a, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65, 0x72,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_customizer_value_status_proto_rawDescOnce sync.Once
	file_customizer_value_status_proto_rawDescData = file_customizer_value_status_proto_rawDesc
)

func file_customizer_value_status_proto_rawDescGZIP() []byte {
	file_customizer_value_status_proto_rawDescOnce.Do(func() {
		file_customizer_value_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_customizer_value_status_proto_rawDescData)
	})
	return file_customizer_value_status_proto_rawDescData
}

var file_customizer_value_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_customizer_value_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_customizer_value_status_proto_goTypes = []interface{}{
...
var file_customizer_value_status_proto_depIdxs = []int32{
...
func init() { file_customizer_value_status_proto_init() }
func file_customizer_value_status_proto_init() {
	if File_customizer_value_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_customizer_value_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_customizer_value_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_customizer_value_status_proto_goTypes,
		DependencyIndexes: file_customizer_value_status_proto_depIdxs,
		EnumInfos:         file_customizer_value_status_proto_enumTypes,
		MessageInfos:      file_customizer_value_status_proto_msgTypes,
	}.Build()
	File_customizer_value_status_proto = out.File
	file_customizer_value_status_proto_rawDesc = nil
	file_customizer_value_status_proto_goTypes = nil
	file_customizer_value_status_proto_depIdxs = nil
}
