...
func (BudgetPeriodEnum_BudgetPeriod) Descriptor() protoreflect.EnumDescriptor {
	return file_budget_period_proto_enumTypes[0].Descriptor()
}

func (BudgetPeriodEnum_BudgetPeriod) Type() protoreflect.EnumType {
	return &file_budget_period_proto_enumTypes[0]
}
...
func (BudgetPeriodEnum_BudgetPeriod) EnumDescriptor() ([]byte, []int) {
	return file_budget_period_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BudgetPeriodEnum) Reset() {
	*x = BudgetPeriodEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_budget_period_proto_msgTypes[0]
...
func (*BudgetPeriodEnum) Descriptor() ([]byte, []int) {
	return file_budget_period_proto_rawDescGZIP(), []int{0}
}

var File_budget_period_proto protoreflect.FileDescriptor

var file_budget_period_proto_rawDesc = []byte{
	0x0a, 0x13, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x5f, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x2e,
	...
	,
...
var (
	file_budget_period_proto_rawDescOnce sync.Once
	file_budget_period_proto_rawDescData = file_budget_period_proto_rawDesc
)

func file_budget_period_proto_rawDescGZIP() []byte {
	file_budget_period_proto_rawDescOnce.Do(func() {
		file_budget_period_proto_rawDescData = protoimpl.X.CompressGZIP(file_budget_period_proto_rawDescData)
	})
	return file_budget_period_proto_rawDescData
}

var file_budget_period_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_budget_period_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_budget_period_proto_goTypes = []interface{}{
...
var file_budget_period_proto_depIdxs = []int32{
...
func init() { file_budget_period_proto_init() }
func file_budget_period_proto_init() {
	if File_budget_period_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_budget_period_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_budget_period_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_budget_period_proto_goTypes,
		DependencyIndexes: file_budget_period_proto_depIdxs,
		EnumInfos:         file_budget_period_proto_enumTypes,
		MessageInfos:      file_budget_period_proto_msgTypes,
	}.Build()
	File_budget_period_proto = out.File
	file_budget_period_proto_rawDesc = nil
	file_budget_period_proto_goTypes = nil
	file_budget_period_proto_depIdxs = nil
}
