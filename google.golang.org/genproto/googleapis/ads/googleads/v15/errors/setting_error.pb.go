...
func (SettingErrorEnum_SettingError) Descriptor() protoreflect.EnumDescriptor {
	return file_setting_error_proto_enumTypes[0].Descriptor()
}

func (SettingErrorEnum_SettingError) Type() protoreflect.EnumType {
	return &file_setting_error_proto_enumTypes[0]
}
...
func (SettingErrorEnum_SettingError) EnumDescriptor() ([]byte, []int) {
	return file_setting_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SettingErrorEnum) Reset() {
	*x = SettingErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_setting_error_proto_msgTypes[0]
...
func (*SettingErrorEnum) Descriptor() ([]byte, []int) {
	return file_setting_error_proto_rawDescGZIP(), []int{0}
}

var File_setting_error_proto protoreflect.FileDescriptor

var file_setting_error_proto_rawDesc = []byte{
	0x0a, 0x13, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e,
...
var (
	file_setting_error_proto_rawDescOnce sync.Once
	file_setting_error_proto_rawDescData = file_setting_error_proto_rawDesc
)

func file_setting_error_proto_rawDescGZIP() []byte {
	file_setting_error_proto_rawDescOnce.Do(func() {
		file_setting_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_setting_error_proto_rawDescData)
	})
	return file_setting_error_proto_rawDescData
}

var file_setting_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_setting_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_setting_error_proto_goTypes = []interface{}{
...
var file_setting_error_proto_depIdxs = []int32{
...
func init() { file_setting_error_proto_init() }
func file_setting_error_proto_init() {
	if File_setting_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_setting_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_setting_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_setting_error_proto_goTypes,
		DependencyIndexes: file_setting_error_proto_depIdxs,
		EnumInfos:         file_setting_error_proto_enumTypes,
		MessageInfos:      file_setting_error_proto_msgTypes,
	}.Build()
	File_setting_error_proto = out.File
	file_setting_error_proto_rawDesc = nil
	file_setting_error_proto_goTypes = nil
	file_setting_error_proto_depIdxs = nil
}
