...
// 	protoc        v5.26.1
// source: operation_access_denied_error.proto
...
func (OperationAccessDeniedErrorEnum_OperationAccessDeniedError) Descriptor() protoreflect.EnumDescriptor {
	return file_operation_access_denied_error_proto_enumTypes[0].Descriptor()
}

func (OperationAccessDeniedErrorEnum_OperationAccessDeniedError) Type() protoreflect.EnumType {
	return &file_operation_access_denied_error_proto_enumTypes[0]
}
...
func (OperationAccessDeniedErrorEnum_OperationAccessDeniedError) EnumDescriptor() ([]byte, []int) {
	return file_operation_access_denied_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *OperationAccessDeniedErrorEnum) Reset() {
	*x = OperationAccessDeniedErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_operation_access_denied_error_proto_msgTypes[0]
...
func (*OperationAccessDeniedErrorEnum) Descriptor() ([]byte, []int) {
	return file_operation_access_denied_error_proto_rawDescGZIP(), []int{0}
}

var File_operation_access_denied_error_proto protoreflect.FileDescriptor

var file_operation_access_denied_error_proto_rawDesc = []byte{
	0x0a, 0x23, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x61, 0x63, 0x63, 0x65,
...
var (
	file_operation_access_denied_error_proto_rawDescOnce sync.Once
	file_operation_access_denied_error_proto_rawDescData = file_operation_access_denied_error_proto_rawDesc
)

func file_operation_access_denied_error_proto_rawDescGZIP() []byte {
	file_operation_access_denied_error_proto_rawDescOnce.Do(func() {
		file_operation_access_denied_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_operation_access_denied_error_proto_rawDescData)
	})
	return file_operation_access_denied_error_proto_rawDescData
}

var file_operation_access_denied_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_operation_access_denied_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_operation_access_denied_error_proto_goTypes = []interface{}{
...
var file_operation_access_denied_error_proto_depIdxs = []int32{
...
func init() { file_operation_access_denied_error_proto_init() }
func file_operation_access_denied_error_proto_init() {
	if File_operation_access_denied_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_operation_access_denied_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_operation_access_denied_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_operation_access_denied_error_proto_goTypes,
		DependencyIndexes: file_operation_access_denied_error_proto_depIdxs,
		EnumInfos:         file_operation_access_denied_error_proto_enumTypes,
		MessageInfos:      file_operation_access_denied_error_proto_msgTypes,
	}.Build()
	File_operation_access_denied_error_proto = out.File
	file_operation_access_denied_error_proto_rawDesc = nil
	file_operation_access_denied_error_proto_goTypes = nil
	file_operation_access_denied_error_proto_depIdxs = nil
}
