...
// 	protoc        v5.26.1
// source: ad_group_feed_error.proto
...
func (AdGroupFeedErrorEnum_AdGroupFeedError) Descriptor() protoreflect.EnumDescriptor {
	return file_ad_group_feed_error_proto_enumTypes[0].Descriptor()
}

func (AdGroupFeedErrorEnum_AdGroupFeedError) Type() protoreflect.EnumType {
	return &file_ad_group_feed_error_proto_enumTypes[0]
}
...
func (AdGroupFeedErrorEnum_AdGroupFeedError) EnumDescriptor() ([]byte, []int) {
	return file_ad_group_feed_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AdGroupFeedErrorEnum) Reset() {
	*x = AdGroupFeedErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ad_group_feed_error_proto_msgTypes[0]
...
func (*AdGroupFeedErrorEnum) Descriptor() ([]byte, []int) {
	return file_ad_group_feed_error_proto_rawDescGZIP(), []int{0}
}

var File_ad_group_feed_error_proto protoreflect.FileDescriptor

var file_ad_group_feed_error_proto_rawDesc = []byte{
	0x0a, 0x19, 0x61, 0x64, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x66, 0x65, 0x65, 0x64, 0x5f,
...
var (
	file_ad_group_feed_error_proto_rawDescOnce sync.Once
	file_ad_group_feed_error_proto_rawDescData = file_ad_group_feed_error_proto_rawDesc
)

func file_ad_group_feed_error_proto_rawDescGZIP() []byte {
	file_ad_group_feed_error_proto_rawDescOnce.Do(func() {
		file_ad_group_feed_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_ad_group_feed_error_proto_rawDescData)
	})
	return file_ad_group_feed_error_proto_rawDescData
}

var file_ad_group_feed_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_ad_group_feed_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ad_group_feed_error_proto_goTypes = []interface{}{
...
var file_ad_group_feed_error_proto_depIdxs = []int32{
...
func init() { file_ad_group_feed_error_proto_init() }
func file_ad_group_feed_error_proto_init() {
	if File_ad_group_feed_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ad_group_feed_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ad_group_feed_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ad_group_feed_error_proto_goTypes,
		DependencyIndexes: file_ad_group_feed_error_proto_depIdxs,
		EnumInfos:         file_ad_group_feed_error_proto_enumTypes,
		MessageInfos:      file_ad_group_feed_error_proto_msgTypes,
	}.Build()
	File_ad_group_feed_error_proto = out.File
	file_ad_group_feed_error_proto_rawDesc = nil
	file_ad_group_feed_error_proto_goTypes = nil
	file_ad_group_feed_error_proto_depIdxs = nil
}
