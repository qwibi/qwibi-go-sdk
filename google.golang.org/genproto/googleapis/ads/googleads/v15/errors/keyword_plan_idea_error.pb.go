...
// 	protoc        v5.26.1
// source: keyword_plan_idea_error.proto
...
func (KeywordPlanIdeaErrorEnum_KeywordPlanIdeaError) Descriptor() protoreflect.EnumDescriptor {
	return file_keyword_plan_idea_error_proto_enumTypes[0].Descriptor()
}

func (KeywordPlanIdeaErrorEnum_KeywordPlanIdeaError) Type() protoreflect.EnumType {
	return &file_keyword_plan_idea_error_proto_enumTypes[0]
}
...
func (KeywordPlanIdeaErrorEnum_KeywordPlanIdeaError) EnumDescriptor() ([]byte, []int) {
	return file_keyword_plan_idea_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *KeywordPlanIdeaErrorEnum) Reset() {
	*x = KeywordPlanIdeaErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_keyword_plan_idea_error_proto_msgTypes[0]
...
func (*KeywordPlanIdeaErrorEnum) Descriptor() ([]byte, []int) {
	return file_keyword_plan_idea_error_proto_rawDescGZIP(), []int{0}
}

var File_keyword_plan_idea_error_proto protoreflect.FileDescriptor

var file_keyword_plan_idea_error_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x5f, 0x70, 0x6c, 0x61, 0x6e, 0x5f, 0x69,
...
var (
	file_keyword_plan_idea_error_proto_rawDescOnce sync.Once
	file_keyword_plan_idea_error_proto_rawDescData = file_keyword_plan_idea_error_proto_rawDesc
)

func file_keyword_plan_idea_error_proto_rawDescGZIP() []byte {
	file_keyword_plan_idea_error_proto_rawDescOnce.Do(func() {
		file_keyword_plan_idea_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_keyword_plan_idea_error_proto_rawDescData)
	})
	return file_keyword_plan_idea_error_proto_rawDescData
}

var file_keyword_plan_idea_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_keyword_plan_idea_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_keyword_plan_idea_error_proto_goTypes = []interface{}{
...
var file_keyword_plan_idea_error_proto_depIdxs = []int32{
...
func init() { file_keyword_plan_idea_error_proto_init() }
func file_keyword_plan_idea_error_proto_init() {
	if File_keyword_plan_idea_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_keyword_plan_idea_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_keyword_plan_idea_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_keyword_plan_idea_error_proto_goTypes,
		DependencyIndexes: file_keyword_plan_idea_error_proto_depIdxs,
		EnumInfos:         file_keyword_plan_idea_error_proto_enumTypes,
		MessageInfos:      file_keyword_plan_idea_error_proto_msgTypes,
	}.Build()
	File_keyword_plan_idea_error_proto = out.File
	file_keyword_plan_idea_error_proto_rawDesc = nil
	file_keyword_plan_idea_error_proto_goTypes = nil
	file_keyword_plan_idea_error_proto_depIdxs = nil
}
