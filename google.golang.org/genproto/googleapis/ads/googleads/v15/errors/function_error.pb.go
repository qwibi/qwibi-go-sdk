...
func (FunctionErrorEnum_FunctionError) Descriptor() protoreflect.EnumDescriptor {
	return file_function_error_proto_enumTypes[0].Descriptor()
}

func (FunctionErrorEnum_FunctionError) Type() protoreflect.EnumType {
	return &file_function_error_proto_enumTypes[0]
}
...
func (FunctionErrorEnum_FunctionError) EnumDescriptor() ([]byte, []int) {
	return file_function_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *FunctionErrorEnum) Reset() {
	*x = FunctionErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_function_error_proto_msgTypes[0]
...
func (*FunctionErrorEnum) Descriptor() ([]byte, []int) {
	return file_function_error_proto_rawDescGZIP(), []int{0}
}

var File_function_error_proto protoreflect.FileDescriptor

var file_function_error_proto_rawDesc = []byte{
	0x0a, 0x14, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72,
...
var (
	file_function_error_proto_rawDescOnce sync.Once
	file_function_error_proto_rawDescData = file_function_error_proto_rawDesc
)

func file_function_error_proto_rawDescGZIP() []byte {
	file_function_error_proto_rawDescOnce.Do(func() {
		file_function_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_function_error_proto_rawDescData)
	})
	return file_function_error_proto_rawDescData
}

var file_function_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_function_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_function_error_proto_goTypes = []interface{}{
...
var file_function_error_proto_depIdxs = []int32{
...
func init() { file_function_error_proto_init() }
func file_function_error_proto_init() {
	if File_function_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_function_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_function_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_function_error_proto_goTypes,
		DependencyIndexes: file_function_error_proto_depIdxs,
		EnumInfos:         file_function_error_proto_enumTypes,
		MessageInfos:      file_function_error_proto_msgTypes,
	}.Build()
	File_function_error_proto = out.File
	file_function_error_proto_rawDesc = nil
	file_function_error_proto_goTypes = nil
	file_function_error_proto_depIdxs = nil
}
