...
// 	protoc        v5.26.1
// source: custom_audience_error.proto
...
func (CustomAudienceErrorEnum_CustomAudienceError) Descriptor() protoreflect.EnumDescriptor {
	return file_custom_audience_error_proto_enumTypes[0].Descriptor()
}

func (CustomAudienceErrorEnum_CustomAudienceError) Type() protoreflect.EnumType {
	return &file_custom_audience_error_proto_enumTypes[0]
}
...
func (CustomAudienceErrorEnum_CustomAudienceError) EnumDescriptor() ([]byte, []int) {
	return file_custom_audience_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CustomAudienceErrorEnum) Reset() {
	*x = CustomAudienceErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_custom_audience_error_proto_msgTypes[0]
...
func (*CustomAudienceErrorEnum) Descriptor() ([]byte, []int) {
	return file_custom_audience_error_proto_rawDescGZIP(), []int{0}
}

var File_custom_audience_error_proto protoreflect.FileDescriptor

var file_custom_audience_error_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x61, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63,
...
var (
	file_custom_audience_error_proto_rawDescOnce sync.Once
	file_custom_audience_error_proto_rawDescData = file_custom_audience_error_proto_rawDesc
)

func file_custom_audience_error_proto_rawDescGZIP() []byte {
	file_custom_audience_error_proto_rawDescOnce.Do(func() {
		file_custom_audience_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_custom_audience_error_proto_rawDescData)
	})
	return file_custom_audience_error_proto_rawDescData
}

var file_custom_audience_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_custom_audience_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_custom_audience_error_proto_goTypes = []interface{}{
...
var file_custom_audience_error_proto_depIdxs = []int32{
...
func init() { file_custom_audience_error_proto_init() }
func file_custom_audience_error_proto_init() {
	if File_custom_audience_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_custom_audience_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_custom_audience_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_custom_audience_error_proto_goTypes,
		DependencyIndexes: file_custom_audience_error_proto_depIdxs,
		EnumInfos:         file_custom_audience_error_proto_enumTypes,
		MessageInfos:      file_custom_audience_error_proto_msgTypes,
	}.Build()
	File_custom_audience_error_proto = out.File
	file_custom_audience_error_proto_rawDesc = nil
	file_custom_audience_error_proto_goTypes = nil
	file_custom_audience_error_proto_depIdxs = nil
}
