...
func (EnumErrorEnum_EnumError) Descriptor() protoreflect.EnumDescriptor {
	return file_enum_error_proto_enumTypes[0].Descriptor()
}

func (EnumErrorEnum_EnumError) Type() protoreflect.EnumType {
	return &file_enum_error_proto_enumTypes[0]
}
...
func (EnumErrorEnum_EnumError) EnumDescriptor() ([]byte, []int) {
	return file_enum_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *EnumErrorEnum) Reset() {
	*x = EnumErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enum_error_proto_msgTypes[0]
...
func (*EnumErrorEnum) Descriptor() ([]byte, []int) {
	return file_enum_error_proto_rawDescGZIP(), []int{0}
}

var File_enum_error_proto protoreflect.FileDescriptor

var file_enum_error_proto_rawDesc = []byte{
	0x0a, 0x10, 0x65, 0x6e, 0x75, 0x6d, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f,
...
var (
	file_enum_error_proto_rawDescOnce sync.Once
	file_enum_error_proto_rawDescData = file_enum_error_proto_rawDesc
)

func file_enum_error_proto_rawDescGZIP() []byte {
	file_enum_error_proto_rawDescOnce.Do(func() {
		file_enum_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_enum_error_proto_rawDescData)
	})
	return file_enum_error_proto_rawDescData
}

var file_enum_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enum_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enum_error_proto_goTypes = []interface{}{
...
var file_enum_error_proto_depIdxs = []int32{
...
func init() { file_enum_error_proto_init() }
func file_enum_error_proto_init() {
	if File_enum_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enum_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enum_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enum_error_proto_goTypes,
		DependencyIndexes: file_enum_error_proto_depIdxs,
		EnumInfos:         file_enum_error_proto_enumTypes,
		MessageInfos:      file_enum_error_proto_msgTypes,
	}.Build()
	File_enum_error_proto = out.File
	file_enum_error_proto_rawDesc = nil
	file_enum_error_proto_goTypes = nil
	file_enum_error_proto_depIdxs = nil
}
