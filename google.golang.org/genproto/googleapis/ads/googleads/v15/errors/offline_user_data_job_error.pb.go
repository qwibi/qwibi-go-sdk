...
// 	protoc        v5.26.1
// source: offline_user_data_job_error.proto
...
func (OfflineUserDataJobErrorEnum_OfflineUserDataJobError) Descriptor() protoreflect.EnumDescriptor {
	return file_offline_user_data_job_error_proto_enumTypes[0].Descriptor()
}

func (OfflineUserDataJobErrorEnum_OfflineUserDataJobError) Type() protoreflect.EnumType {
	return &file_offline_user_data_job_error_proto_enumTypes[0]
}
...
func (OfflineUserDataJobErrorEnum_OfflineUserDataJobError) EnumDescriptor() ([]byte, []int) {
	return file_offline_user_data_job_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *OfflineUserDataJobErrorEnum) Reset() {
	*x = OfflineUserDataJobErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_offline_user_data_job_error_proto_msgTypes[0]
...
func (*OfflineUserDataJobErrorEnum) Descriptor() ([]byte, []int) {
	return file_offline_user_data_job_error_proto_rawDescGZIP(), []int{0}
}

var File_offline_user_data_job_error_proto protoreflect.FileDescriptor

var file_offline_user_data_job_error_proto_rawDesc = []byte{
	0x0a, 0x21, 0x6f, 0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x64,
...
var (
	file_offline_user_data_job_error_proto_rawDescOnce sync.Once
	file_offline_user_data_job_error_proto_rawDescData = file_offline_user_data_job_error_proto_rawDesc
)

func file_offline_user_data_job_error_proto_rawDescGZIP() []byte {
	file_offline_user_data_job_error_proto_rawDescOnce.Do(func() {
		file_offline_user_data_job_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_offline_user_data_job_error_proto_rawDescData)
	})
	return file_offline_user_data_job_error_proto_rawDescData
}

var file_offline_user_data_job_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_offline_user_data_job_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_offline_user_data_job_error_proto_goTypes = []interface{}{
...
var file_offline_user_data_job_error_proto_depIdxs = []int32{
...
func init() { file_offline_user_data_job_error_proto_init() }
func file_offline_user_data_job_error_proto_init() {
	if File_offline_user_data_job_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_offline_user_data_job_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_offline_user_data_job_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_offline_user_data_job_error_proto_goTypes,
		DependencyIndexes: file_offline_user_data_job_error_proto_depIdxs,
		EnumInfos:         file_offline_user_data_job_error_proto_enumTypes,
		MessageInfos:      file_offline_user_data_job_error_proto_msgTypes,
	}.Build()
	File_offline_user_data_job_error_proto = out.File
	file_offline_user_data_job_error_proto_rawDesc = nil
	file_offline_user_data_job_error_proto_goTypes = nil
	file_offline_user_data_job_error_proto_depIdxs = nil
}
