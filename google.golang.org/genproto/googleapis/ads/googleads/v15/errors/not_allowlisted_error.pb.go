...
// 	protoc        v5.26.1
// source: not_allowlisted_error.proto
...
func (NotAllowlistedErrorEnum_NotAllowlistedError) Descriptor() protoreflect.EnumDescriptor {
	return file_not_allowlisted_error_proto_enumTypes[0].Descriptor()
}

func (NotAllowlistedErrorEnum_NotAllowlistedError) Type() protoreflect.EnumType {
	return &file_not_allowlisted_error_proto_enumTypes[0]
}
...
func (NotAllowlistedErrorEnum_NotAllowlistedError) EnumDescriptor() ([]byte, []int) {
	return file_not_allowlisted_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *NotAllowlistedErrorEnum) Reset() {
	*x = NotAllowlistedErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_not_allowlisted_error_proto_msgTypes[0]
...
func (*NotAllowlistedErrorEnum) Descriptor() ([]byte, []int) {
	return file_not_allowlisted_error_proto_rawDescGZIP(), []int{0}
}

var File_not_allowlisted_error_proto protoreflect.FileDescriptor

var file_not_allowlisted_error_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x6e, 0x6f, 0x74, 0x5f, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x6c, 0x69, 0x73, 0x74, 0x65,
...
var (
	file_not_allowlisted_error_proto_rawDescOnce sync.Once
	file_not_allowlisted_error_proto_rawDescData = file_not_allowlisted_error_proto_rawDesc
)

func file_not_allowlisted_error_proto_rawDescGZIP() []byte {
	file_not_allowlisted_error_proto_rawDescOnce.Do(func() {
		file_not_allowlisted_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_not_allowlisted_error_proto_rawDescData)
	})
	return file_not_allowlisted_error_proto_rawDescData
}

var file_not_allowlisted_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_not_allowlisted_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_not_allowlisted_error_proto_goTypes = []interface{}{
...
var file_not_allowlisted_error_proto_depIdxs = []int32{
...
func init() { file_not_allowlisted_error_proto_init() }
func file_not_allowlisted_error_proto_init() {
	if File_not_allowlisted_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_not_allowlisted_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_not_allowlisted_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_not_allowlisted_error_proto_goTypes,
		DependencyIndexes: file_not_allowlisted_error_proto_depIdxs,
		EnumInfos:         file_not_allowlisted_error_proto_enumTypes,
		MessageInfos:      file_not_allowlisted_error_proto_msgTypes,
	}.Build()
	File_not_allowlisted_error_proto = out.File
	file_not_allowlisted_error_proto_rawDesc = nil
	file_not_allowlisted_error_proto_goTypes = nil
	file_not_allowlisted_error_proto_depIdxs = nil
}
