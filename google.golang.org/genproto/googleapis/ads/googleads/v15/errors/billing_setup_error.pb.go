...
// 	protoc        v5.26.1
// source: billing_setup_error.proto
...
func (BillingSetupErrorEnum_BillingSetupError) Descriptor() protoreflect.EnumDescriptor {
	return file_billing_setup_error_proto_enumTypes[0].Descriptor()
}

func (BillingSetupErrorEnum_BillingSetupError) Type() protoreflect.EnumType {
	return &file_billing_setup_error_proto_enumTypes[0]
}
...
func (BillingSetupErrorEnum_BillingSetupError) EnumDescriptor() ([]byte, []int) {
	return file_billing_setup_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BillingSetupErrorEnum) Reset() {
	*x = BillingSetupErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_billing_setup_error_proto_msgTypes[0]
...
func (*BillingSetupErrorEnum) Descriptor() ([]byte, []int) {
	return file_billing_setup_error_proto_rawDescGZIP(), []int{0}
}

var File_billing_setup_error_proto protoreflect.FileDescriptor

var file_billing_setup_error_proto_rawDesc = []byte{
	0x0a, 0x19, 0x62, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x5f, 0x73, 0x65, 0x74, 0x75, 0x70, 0x5f,
...
var (
	file_billing_setup_error_proto_rawDescOnce sync.Once
	file_billing_setup_error_proto_rawDescData = file_billing_setup_error_proto_rawDesc
)

func file_billing_setup_error_proto_rawDescGZIP() []byte {
	file_billing_setup_error_proto_rawDescOnce.Do(func() {
		file_billing_setup_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_billing_setup_error_proto_rawDescData)
	})
	return file_billing_setup_error_proto_rawDescData
}

var file_billing_setup_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_billing_setup_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_billing_setup_error_proto_goTypes = []interface{}{
...
var file_billing_setup_error_proto_depIdxs = []int32{
...
func init() { file_billing_setup_error_proto_init() }
func file_billing_setup_error_proto_init() {
	if File_billing_setup_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_billing_setup_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_billing_setup_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_billing_setup_error_proto_goTypes,
		DependencyIndexes: file_billing_setup_error_proto_depIdxs,
		EnumInfos:         file_billing_setup_error_proto_enumTypes,
		MessageInfos:      file_billing_setup_error_proto_msgTypes,
	}.Build()
	File_billing_setup_error_proto = out.File
	file_billing_setup_error_proto_rawDesc = nil
	file_billing_setup_error_proto_goTypes = nil
	file_billing_setup_error_proto_depIdxs = nil
}
