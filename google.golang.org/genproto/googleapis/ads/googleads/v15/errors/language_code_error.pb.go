...
// 	protoc        v5.26.1
// source: language_code_error.proto
...
func (LanguageCodeErrorEnum_LanguageCodeError) Descriptor() protoreflect.EnumDescriptor {
	return file_language_code_error_proto_enumTypes[0].Descriptor()
}

func (LanguageCodeErrorEnum_LanguageCodeError) Type() protoreflect.EnumType {
	return &file_language_code_error_proto_enumTypes[0]
}
...
func (LanguageCodeErrorEnum_LanguageCodeError) EnumDescriptor() ([]byte, []int) {
	return file_language_code_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *LanguageCodeErrorEnum) Reset() {
	*x = LanguageCodeErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_language_code_error_proto_msgTypes[0]
...
func (*LanguageCodeErrorEnum) Descriptor() ([]byte, []int) {
	return file_language_code_error_proto_rawDescGZIP(), []int{0}
}

var File_language_code_error_proto protoreflect.FileDescriptor

var file_language_code_error_proto_rawDesc = []byte{
	0x0a, 0x19, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x5f,
...
var (
	file_language_code_error_proto_rawDescOnce sync.Once
	file_language_code_error_proto_rawDescData = file_language_code_error_proto_rawDesc
)

func file_language_code_error_proto_rawDescGZIP() []byte {
	file_language_code_error_proto_rawDescOnce.Do(func() {
		file_language_code_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_language_code_error_proto_rawDescData)
	})
	return file_language_code_error_proto_rawDescData
}

var file_language_code_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_language_code_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_language_code_error_proto_goTypes = []interface{}{
...
var file_language_code_error_proto_depIdxs = []int32{
...
func init() { file_language_code_error_proto_init() }
func file_language_code_error_proto_init() {
	if File_language_code_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_language_code_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_language_code_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_language_code_error_proto_goTypes,
		DependencyIndexes: file_language_code_error_proto_depIdxs,
		EnumInfos:         file_language_code_error_proto_enumTypes,
		MessageInfos:      file_language_code_error_proto_msgTypes,
	}.Build()
	File_language_code_error_proto = out.File
	file_language_code_error_proto_rawDesc = nil
	file_language_code_error_proto_goTypes = nil
	file_language_code_error_proto_depIdxs = nil
}
