...
// 	protoc        v5.26.1
// source: authentication_error.proto
...
func (AuthenticationErrorEnum_AuthenticationError) Descriptor() protoreflect.EnumDescriptor {
	return file_authentication_error_proto_enumTypes[0].Descriptor()
}

func (AuthenticationErrorEnum_AuthenticationError) Type() protoreflect.EnumType {
	return &file_authentication_error_proto_enumTypes[0]
}
...
func (AuthenticationErrorEnum_AuthenticationError) EnumDescriptor() ([]byte, []int) {
	return file_authentication_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AuthenticationErrorEnum) Reset() {
	*x = AuthenticationErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_authentication_error_proto_msgTypes[0]
...
func (*AuthenticationErrorEnum) Descriptor() ([]byte, []int) {
	return file_authentication_error_proto_rawDescGZIP(), []int{0}
}

var File_authentication_error_proto protoreflect.FileDescriptor

var file_authentication_error_proto_rawDesc = []byte{
...
var (
	file_authentication_error_proto_rawDescOnce sync.Once
	file_authentication_error_proto_rawDescData = file_authentication_error_proto_rawDesc
)

func file_authentication_error_proto_rawDescGZIP() []byte {
	file_authentication_error_proto_rawDescOnce.Do(func() {
		file_authentication_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_authentication_error_proto_rawDescData)
	})
	return file_authentication_error_proto_rawDescData
}

var file_authentication_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_authentication_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_authentication_error_proto_goTypes = []interface{}{
...
var file_authentication_error_proto_depIdxs = []int32{
...
func init() { file_authentication_error_proto_init() }
func file_authentication_error_proto_init() {
	if File_authentication_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_authentication_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_authentication_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_authentication_error_proto_goTypes,
		DependencyIndexes: file_authentication_error_proto_depIdxs,
		EnumInfos:         file_authentication_error_proto_enumTypes,
		MessageInfos:      file_authentication_error_proto_msgTypes,
	}.Build()
	File_authentication_error_proto = out.File
	file_authentication_error_proto_rawDesc = nil
	file_authentication_error_proto_goTypes = nil
	file_authentication_error_proto_depIdxs = nil
}
