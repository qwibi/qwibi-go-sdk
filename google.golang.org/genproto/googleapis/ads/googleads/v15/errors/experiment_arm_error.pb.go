...
// 	protoc        v5.26.1
// source: experiment_arm_error.proto
...
func (ExperimentArmErrorEnum_ExperimentArmError) Descriptor() protoreflect.EnumDescriptor {
	return file_experiment_arm_error_proto_enumTypes[0].Descriptor()
}

func (ExperimentArmErrorEnum_ExperimentArmError) Type() protoreflect.EnumType {
	return &file_experiment_arm_error_proto_enumTypes[0]
}
...
func (ExperimentArmErrorEnum_ExperimentArmError) EnumDescriptor() ([]byte, []int) {
	return file_experiment_arm_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ExperimentArmErrorEnum) Reset() {
	*x = ExperimentArmErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_experiment_arm_error_proto_msgTypes[0]
...
func (*ExperimentArmErrorEnum) Descriptor() ([]byte, []int) {
	return file_experiment_arm_error_proto_rawDescGZIP(), []int{0}
}

var File_experiment_arm_error_proto protoreflect.FileDescriptor

var file_experiment_arm_error_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x65, 0x78, 0x70, 0x65, 0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x72, 0x6d,
...
var (
	file_experiment_arm_error_proto_rawDescOnce sync.Once
	file_experiment_arm_error_proto_rawDescData = file_experiment_arm_error_proto_rawDesc
)

func file_experiment_arm_error_proto_rawDescGZIP() []byte {
	file_experiment_arm_error_proto_rawDescOnce.Do(func() {
		file_experiment_arm_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_experiment_arm_error_proto_rawDescData)
	})
	return file_experiment_arm_error_proto_rawDescData
}

var file_experiment_arm_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_experiment_arm_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_experiment_arm_error_proto_goTypes = []interface{}{
...
var file_experiment_arm_error_proto_depIdxs = []int32{
...
func init() { file_experiment_arm_error_proto_init() }
func file_experiment_arm_error_proto_init() {
	if File_experiment_arm_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_experiment_arm_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_experiment_arm_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_experiment_arm_error_proto_goTypes,
		DependencyIndexes: file_experiment_arm_error_proto_depIdxs,
		EnumInfos:         file_experiment_arm_error_proto_enumTypes,
		MessageInfos:      file_experiment_arm_error_proto_msgTypes,
	}.Build()
	File_experiment_arm_error_proto = out.File
	file_experiment_arm_error_proto_rawDesc = nil
	file_experiment_arm_error_proto_goTypes = nil
	file_experiment_arm_error_proto_depIdxs = nil
}
