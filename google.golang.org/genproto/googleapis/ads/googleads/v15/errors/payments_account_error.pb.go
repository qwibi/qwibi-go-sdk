...
// 	protoc        v5.26.1
// source: payments_account_error.proto
...
func (PaymentsAccountErrorEnum_PaymentsAccountError) Descriptor() protoreflect.EnumDescriptor {
	return file_payments_account_error_proto_enumTypes[0].Descriptor()
}

func (PaymentsAccountErrorEnum_PaymentsAccountError) Type() protoreflect.EnumType {
	return &file_payments_account_error_proto_enumTypes[0]
}
...
func (PaymentsAccountErrorEnum_PaymentsAccountError) EnumDescriptor() ([]byte, []int) {
	return file_payments_account_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *PaymentsAccountErrorEnum) Reset() {
	*x = PaymentsAccountErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_payments_account_error_proto_msgTypes[0]
...
func (*PaymentsAccountErrorEnum) Descriptor() ([]byte, []int) {
	return file_payments_account_error_proto_rawDescGZIP(), []int{0}
}

var File_payments_account_error_proto protoreflect.FileDescriptor

var file_payments_account_error_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75,
...
var (
	file_payments_account_error_proto_rawDescOnce sync.Once
	file_payments_account_error_proto_rawDescData = file_payments_account_error_proto_rawDesc
)

func file_payments_account_error_proto_rawDescGZIP() []byte {
	file_payments_account_error_proto_rawDescOnce.Do(func() {
		file_payments_account_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_payments_account_error_proto_rawDescData)
	})
	return file_payments_account_error_proto_rawDescData
}

var file_payments_account_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_payments_account_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_payments_account_error_proto_goTypes = []interface{}{
...
var file_payments_account_error_proto_depIdxs = []int32{
...
func init() { file_payments_account_error_proto_init() }
func file_payments_account_error_proto_init() {
	if File_payments_account_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_payments_account_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_payments_account_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_payments_account_error_proto_goTypes,
		DependencyIndexes: file_payments_account_error_proto_depIdxs,
		EnumInfos:         file_payments_account_error_proto_enumTypes,
		MessageInfos:      file_payments_account_error_proto_msgTypes,
	}.Build()
	File_payments_account_error_proto = out.File
	file_payments_account_error_proto_rawDesc = nil
	file_payments_account_error_proto_goTypes = nil
	file_payments_account_error_proto_depIdxs = nil
}
