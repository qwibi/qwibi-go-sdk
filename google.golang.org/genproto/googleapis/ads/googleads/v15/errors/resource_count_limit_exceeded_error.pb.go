...
// 	protoc        v5.26.1
// source: resource_count_limit_exceeded_error.proto
...
func (ResourceCountLimitExceededErrorEnum_ResourceCountLimitExceededError) Descriptor() protoreflect.EnumDescriptor {
	return file_resource_count_limit_exceeded_error_proto_enumTypes[0].Descriptor()
}

func (ResourceCountLimitExceededErrorEnum_ResourceCountLimitExceededError) Type() protoreflect.EnumType {
	return &file_resource_count_limit_exceeded_error_proto_enumTypes[0]
}
...
func (ResourceCountLimitExceededErrorEnum_ResourceCountLimitExceededError) EnumDescriptor() ([]byte, []int) {
	return file_resource_count_limit_exceeded_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ResourceCountLimitExceededErrorEnum) Reset() {
	*x = ResourceCountLimitExceededErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resource_count_limit_exceeded_error_proto_msgTypes[0]
...
func (*ResourceCountLimitExceededErrorEnum) Descriptor() ([]byte, []int) {
	return file_resource_count_limit_exceeded_error_proto_rawDescGZIP(), []int{0}
}

var File_resource_count_limit_exceeded_error_proto protoreflect.FileDescriptor

var file_resource_count_limit_exceeded_error_proto_rawDesc = []byte{
	0x0a, 0x29, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74,
...
var (
	file_resource_count_limit_exceeded_error_proto_rawDescOnce sync.Once
	file_resource_count_limit_exceeded_error_proto_rawDescData = file_resource_count_limit_exceeded_error_proto_rawDesc
)

func file_resource_count_limit_exceeded_error_proto_rawDescGZIP() []byte {
	file_resource_count_limit_exceeded_error_proto_rawDescOnce.Do(func() {
		file_resource_count_limit_exceeded_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_resource_count_limit_exceeded_error_proto_rawDescData)
	})
	return file_resource_count_limit_exceeded_error_proto_rawDescData
}

var file_resource_count_limit_exceeded_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_resource_count_limit_exceeded_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resource_count_limit_exceeded_error_proto_goTypes = []interface{}{
...
var file_resource_count_limit_exceeded_error_proto_depIdxs = []int32{
...
func init() { file_resource_count_limit_exceeded_error_proto_init() }
func file_resource_count_limit_exceeded_error_proto_init() {
	if File_resource_count_limit_exceeded_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resource_count_limit_exceeded_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resource_count_limit_exceeded_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resource_count_limit_exceeded_error_proto_goTypes,
		DependencyIndexes: file_resource_count_limit_exceeded_error_proto_depIdxs,
		EnumInfos:         file_resource_count_limit_exceeded_error_proto_enumTypes,
		MessageInfos:      file_resource_count_limit_exceeded_error_proto_msgTypes,
	}.Build()
	File_resource_count_limit_exceeded_error_proto = out.File
	file_resource_count_limit_exceeded_error_proto_rawDesc = nil
	file_resource_count_limit_exceeded_error_proto_goTypes = nil
	file_resource_count_limit_exceeded_error_proto_depIdxs = nil
}
