...
func (UserListErrorEnum_UserListError) Descriptor() protoreflect.EnumDescriptor {
	return file_user_list_error_proto_enumTypes[0].Descriptor()
}

func (UserListErrorEnum_UserListError) Type() protoreflect.EnumType {
	return &file_user_list_error_proto_enumTypes[0]
}
...
func (UserListErrorEnum_UserListError) EnumDescriptor() ([]byte, []int) {
	return file_user_list_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *UserListErrorEnum) Reset() {
	*x = UserListErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_user_list_error_proto_msgTypes[0]
...
func (*UserListErrorEnum) Descriptor() ([]byte, []int) {
	return file_user_list_error_proto_rawDescGZIP(), []int{0}
}

var File_user_list_error_proto protoreflect.FileDescriptor

var file_user_list_error_proto_rawDesc = []byte{
	0x0a, 0x15, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x65, 0x72, 0x72, 0x6f,
...
var (
	file_user_list_error_proto_rawDescOnce sync.Once
	file_user_list_error_proto_rawDescData = file_user_list_error_proto_rawDesc
)

func file_user_list_error_proto_rawDescGZIP() []byte {
	file_user_list_error_proto_rawDescOnce.Do(func() {
		file_user_list_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_user_list_error_proto_rawDescData)
	})
	return file_user_list_error_proto_rawDescData
}

var file_user_list_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_user_list_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_user_list_error_proto_goTypes = []interface{}{
...
var file_user_list_error_proto_depIdxs = []int32{
...
func init() { file_user_list_error_proto_init() }
func file_user_list_error_proto_init() {
	if File_user_list_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_user_list_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_user_list_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_user_list_error_proto_goTypes,
		DependencyIndexes: file_user_list_error_proto_depIdxs,
		EnumInfos:         file_user_list_error_proto_enumTypes,
		MessageInfos:      file_user_list_error_proto_msgTypes,
	}.Build()
	File_user_list_error_proto = out.File
	file_user_list_error_proto_rawDesc = nil
	file_user_list_error_proto_goTypes = nil
	file_user_list_error_proto_depIdxs = nil
}
