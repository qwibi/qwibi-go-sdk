...
func (BatchJobErrorEnum_BatchJobError) Descriptor() protoreflect.EnumDescriptor {
	return file_batch_job_error_proto_enumTypes[0].Descriptor()
}

func (BatchJobErrorEnum_BatchJobError) Type() protoreflect.EnumType {
	return &file_batch_job_error_proto_enumTypes[0]
}
...
func (BatchJobErrorEnum_BatchJobError) EnumDescriptor() ([]byte, []int) {
	return file_batch_job_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BatchJobErrorEnum) Reset() {
	*x = BatchJobErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_batch_job_error_proto_msgTypes[0]
...
func (*BatchJobErrorEnum) Descriptor() ([]byte, []int) {
	return file_batch_job_error_proto_rawDescGZIP(), []int{0}
}

var File_batch_job_error_proto protoreflect.FileDescriptor

var file_batch_job_error_proto_rawDesc = []byte{
	0x0a, 0x15, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x6a, 0x6f, 0x62, 0x5f, 0x65, 0x72, 0x72, 0x6f,
...
var (
	file_batch_job_error_proto_rawDescOnce sync.Once
	file_batch_job_error_proto_rawDescData = file_batch_job_error_proto_rawDesc
)

func file_batch_job_error_proto_rawDescGZIP() []byte {
	file_batch_job_error_proto_rawDescOnce.Do(func() {
		file_batch_job_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_batch_job_error_proto_rawDescData)
	})
	return file_batch_job_error_proto_rawDescData
}

var file_batch_job_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_batch_job_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_batch_job_error_proto_goTypes = []interface{}{
...
var file_batch_job_error_proto_depIdxs = []int32{
...
func init() { file_batch_job_error_proto_init() }
func file_batch_job_error_proto_init() {
	if File_batch_job_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_batch_job_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_batch_job_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_batch_job_error_proto_goTypes,
		DependencyIndexes: file_batch_job_error_proto_depIdxs,
		EnumInfos:         file_batch_job_error_proto_enumTypes,
		MessageInfos:      file_batch_job_error_proto_msgTypes,
	}.Build()
	File_batch_job_error_proto = out.File
	file_batch_job_error_proto_rawDesc = nil
	file_batch_job_error_proto_goTypes = nil
	file_batch_job_error_proto_depIdxs = nil
}
