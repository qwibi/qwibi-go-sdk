...
// 	protoc        v5.26.1
// source: change_event_error.proto
...
func (ChangeEventErrorEnum_ChangeEventError) Descriptor() protoreflect.EnumDescriptor {
	return file_change_event_error_proto_enumTypes[0].Descriptor()
}

func (ChangeEventErrorEnum_ChangeEventError) Type() protoreflect.EnumType {
	return &file_change_event_error_proto_enumTypes[0]
}
...
func (ChangeEventErrorEnum_ChangeEventError) EnumDescriptor() ([]byte, []int) {
	return file_change_event_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ChangeEventErrorEnum) Reset() {
	*x = ChangeEventErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_change_event_error_proto_msgTypes[0]
...
func (*ChangeEventErrorEnum) Descriptor() ([]byte, []int) {
	return file_change_event_error_proto_rawDescGZIP(), []int{0}
}

var File_change_event_error_proto protoreflect.FileDescriptor

var file_change_event_error_proto_rawDesc = []byte{
	0x0a, 0x18, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x65,
...
var (
	file_change_event_error_proto_rawDescOnce sync.Once
	file_change_event_error_proto_rawDescData = file_change_event_error_proto_rawDesc
)

func file_change_event_error_proto_rawDescGZIP() []byte {
	file_change_event_error_proto_rawDescOnce.Do(func() {
		file_change_event_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_change_event_error_proto_rawDescData)
	})
	return file_change_event_error_proto_rawDescData
}

var file_change_event_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_change_event_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_change_event_error_proto_goTypes = []interface{}{
...
var file_change_event_error_proto_depIdxs = []int32{
...
func init() { file_change_event_error_proto_init() }
func file_change_event_error_proto_init() {
	if File_change_event_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_change_event_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_change_event_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_change_event_error_proto_goTypes,
		DependencyIndexes: file_change_event_error_proto_depIdxs,
		EnumInfos:         file_change_event_error_proto_enumTypes,
		MessageInfos:      file_change_event_error_proto_msgTypes,
	}.Build()
	File_change_event_error_proto = out.File
	file_change_event_error_proto_rawDesc = nil
	file_change_event_error_proto_goTypes = nil
	file_change_event_error_proto_depIdxs = nil
}
