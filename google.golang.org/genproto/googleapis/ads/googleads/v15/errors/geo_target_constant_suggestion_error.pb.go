...
// 	protoc        v5.26.1
// source: geo_target_constant_suggestion_error.proto
...
func (GeoTargetConstantSuggestionErrorEnum_GeoTargetConstantSuggestionError) Descriptor() protoreflect.EnumDescriptor {
	return file_geo_target_constant_suggestion_error_proto_enumTypes[0].Descriptor()
}

func (GeoTargetConstantSuggestionErrorEnum_GeoTargetConstantSuggestionError) Type() protoreflect.EnumType {
	return &file_geo_target_constant_suggestion_error_proto_enumTypes[0]
}
...
func (GeoTargetConstantSuggestionErrorEnum_GeoTargetConstantSuggestionError) EnumDescriptor() ([]byte, []int) {
	return file_geo_target_constant_suggestion_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *GeoTargetConstantSuggestionErrorEnum) Reset() {
	*x = GeoTargetConstantSuggestionErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_geo_target_constant_suggestion_error_proto_msgTypes[0]
...
func (*GeoTargetConstantSuggestionErrorEnum) Descriptor() ([]byte, []int) {
	return file_geo_target_constant_suggestion_error_proto_rawDescGZIP(), []int{0}
}

var File_geo_target_constant_suggestion_error_proto protoreflect.FileDescriptor

var file_geo_target_constant_suggestion_error_proto_rawDesc = []byte{
	0x0a, 0x2a, 0x67, 0x65, 0x6f, 0x5f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x63, 0x6f, 0x6e,
...
var (
	file_geo_target_constant_suggestion_error_proto_rawDescOnce sync.Once
	file_geo_target_constant_suggestion_error_proto_rawDescData = file_geo_target_constant_suggestion_error_proto_rawDesc
)

func file_geo_target_constant_suggestion_error_proto_rawDescGZIP() []byte {
	file_geo_target_constant_suggestion_error_proto_rawDescOnce.Do(func() {
		file_geo_target_constant_suggestion_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_geo_target_constant_suggestion_error_proto_rawDescData)
	})
	return file_geo_target_constant_suggestion_error_proto_rawDescData
}

var file_geo_target_constant_suggestion_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_geo_target_constant_suggestion_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_geo_target_constant_suggestion_error_proto_goTypes = []interface{}{
...
var file_geo_target_constant_suggestion_error_proto_depIdxs = []int32{
...
func init() { file_geo_target_constant_suggestion_error_proto_init() }
func file_geo_target_constant_suggestion_error_proto_init() {
	if File_geo_target_constant_suggestion_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_geo_target_constant_suggestion_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_geo_target_constant_suggestion_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_geo_target_constant_suggestion_error_proto_goTypes,
		DependencyIndexes: file_geo_target_constant_suggestion_error_proto_depIdxs,
		EnumInfos:         file_geo_target_constant_suggestion_error_proto_enumTypes,
		MessageInfos:      file_geo_target_constant_suggestion_error_proto_msgTypes,
	}.Build()
	File_geo_target_constant_suggestion_error_proto = out.File
	file_geo_target_constant_suggestion_error_proto_rawDesc = nil
	file_geo_target_constant_suggestion_error_proto_goTypes = nil
	file_geo_target_constant_suggestion_error_proto_depIdxs = nil
}
