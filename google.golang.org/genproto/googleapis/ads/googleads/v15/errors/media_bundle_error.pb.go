...
// 	protoc        v5.26.1
// source: media_bundle_error.proto
...
func (MediaBundleErrorEnum_MediaBundleError) Descriptor() protoreflect.EnumDescriptor {
	return file_media_bundle_error_proto_enumTypes[0].Descriptor()
}

func (MediaBundleErrorEnum_MediaBundleError) Type() protoreflect.EnumType {
	return &file_media_bundle_error_proto_enumTypes[0]
}
...
func (MediaBundleErrorEnum_MediaBundleError) EnumDescriptor() ([]byte, []int) {
	return file_media_bundle_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *MediaBundleErrorEnum) Reset() {
	*x = MediaBundleErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_media_bundle_error_proto_msgTypes[0]
...
func (*MediaBundleErrorEnum) Descriptor() ([]byte, []int) {
	return file_media_bundle_error_proto_rawDescGZIP(), []int{0}
}

var File_media_bundle_error_proto protoreflect.FileDescriptor

var file_media_bundle_error_proto_rawDesc = []byte{
	0x0a, 0x18, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x5f, 0x62, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x5f, 0x65,
...
var (
	file_media_bundle_error_proto_rawDescOnce sync.Once
	file_media_bundle_error_proto_rawDescData = file_media_bundle_error_proto_rawDesc
)

func file_media_bundle_error_proto_rawDescGZIP() []byte {
	file_media_bundle_error_proto_rawDescOnce.Do(func() {
		file_media_bundle_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_media_bundle_error_proto_rawDescData)
	})
	return file_media_bundle_error_proto_rawDescData
}

var file_media_bundle_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_media_bundle_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_media_bundle_error_proto_goTypes = []interface{}{
...
var file_media_bundle_error_proto_depIdxs = []int32{
...
func init() { file_media_bundle_error_proto_init() }
func file_media_bundle_error_proto_init() {
	if File_media_bundle_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_media_bundle_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_media_bundle_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_media_bundle_error_proto_goTypes,
		DependencyIndexes: file_media_bundle_error_proto_depIdxs,
		EnumInfos:         file_media_bundle_error_proto_enumTypes,
		MessageInfos:      file_media_bundle_error_proto_msgTypes,
	}.Build()
	File_media_bundle_error_proto = out.File
	file_media_bundle_error_proto_rawDesc = nil
	file_media_bundle_error_proto_goTypes = nil
	file_media_bundle_error_proto_depIdxs = nil
}
