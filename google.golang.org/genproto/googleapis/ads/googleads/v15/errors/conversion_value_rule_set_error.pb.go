...
// 	protoc        v5.26.1
// source: conversion_value_rule_set_error.proto
...
func (ConversionValueRuleSetErrorEnum_ConversionValueRuleSetError) Descriptor() protoreflect.EnumDescriptor {
	return file_conversion_value_rule_set_error_proto_enumTypes[0].Descriptor()
}

func (ConversionValueRuleSetErrorEnum_ConversionValueRuleSetError) Type() protoreflect.EnumType {
	return &file_conversion_value_rule_set_error_proto_enumTypes[0]
}
...
func (ConversionValueRuleSetErrorEnum_ConversionValueRuleSetError) EnumDescriptor() ([]byte, []int) {
	return file_conversion_value_rule_set_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConversionValueRuleSetErrorEnum) Reset() {
	*x = ConversionValueRuleSetErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_conversion_value_rule_set_error_proto_msgTypes[0]
...
func (*ConversionValueRuleSetErrorEnum) Descriptor() ([]byte, []int) {
	return file_conversion_value_rule_set_error_proto_rawDescGZIP(), []int{0}
}

var File_conversion_value_rule_set_error_proto protoreflect.FileDescriptor

var file_conversion_value_rule_set_error_proto_rawDesc = []byte{
	0x0a, 0x25, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x76, 0x61, 0x6c,
...
var (
	file_conversion_value_rule_set_error_proto_rawDescOnce sync.Once
	file_conversion_value_rule_set_error_proto_rawDescData = file_conversion_value_rule_set_error_proto_rawDesc
)

func file_conversion_value_rule_set_error_proto_rawDescGZIP() []byte {
	file_conversion_value_rule_set_error_proto_rawDescOnce.Do(func() {
		file_conversion_value_rule_set_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_conversion_value_rule_set_error_proto_rawDescData)
	})
	return file_conversion_value_rule_set_error_proto_rawDescData
}

var file_conversion_value_rule_set_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_conversion_value_rule_set_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_conversion_value_rule_set_error_proto_goTypes = []interface{}{
...
var file_conversion_value_rule_set_error_proto_depIdxs = []int32{
...
func init() { file_conversion_value_rule_set_error_proto_init() }
func file_conversion_value_rule_set_error_proto_init() {
	if File_conversion_value_rule_set_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_conversion_value_rule_set_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_conversion_value_rule_set_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_conversion_value_rule_set_error_proto_goTypes,
		DependencyIndexes: file_conversion_value_rule_set_error_proto_depIdxs,
		EnumInfos:         file_conversion_value_rule_set_error_proto_enumTypes,
		MessageInfos:      file_conversion_value_rule_set_error_proto_msgTypes,
	}.Build()
	File_conversion_value_rule_set_error_proto = out.File
	file_conversion_value_rule_set_error_proto_rawDesc = nil
	file_conversion_value_rule_set_error_proto_goTypes = nil
	file_conversion_value_rule_set_error_proto_depIdxs = nil
}
