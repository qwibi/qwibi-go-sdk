...
// 	protoc        v5.26.1
// source: search_term_insight_error.proto
...
func (SearchTermInsightErrorEnum_SearchTermInsightError) Descriptor() protoreflect.EnumDescriptor {
	return file_search_term_insight_error_proto_enumTypes[0].Descriptor()
}

func (SearchTermInsightErrorEnum_SearchTermInsightError) Type() protoreflect.EnumType {
	return &file_search_term_insight_error_proto_enumTypes[0]
}
...
func (SearchTermInsightErrorEnum_SearchTermInsightError) EnumDescriptor() ([]byte, []int) {
	return file_search_term_insight_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SearchTermInsightErrorEnum) Reset() {
	*x = SearchTermInsightErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_search_term_insight_error_proto_msgTypes[0]
...
func (*SearchTermInsightErrorEnum) Descriptor() ([]byte, []int) {
	return file_search_term_insight_error_proto_rawDescGZIP(), []int{0}
}

var File_search_term_insight_error_proto protoreflect.FileDescriptor

var file_search_term_insight_error_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x5f, 0x74, 0x65, 0x72, 0x6d, 0x5f, 0x69, 0x6e,
...
var (
	file_search_term_insight_error_proto_rawDescOnce sync.Once
	file_search_term_insight_error_proto_rawDescData = file_search_term_insight_error_proto_rawDesc
)

func file_search_term_insight_error_proto_rawDescGZIP() []byte {
	file_search_term_insight_error_proto_rawDescOnce.Do(func() {
		file_search_term_insight_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_search_term_insight_error_proto_rawDescData)
	})
	return file_search_term_insight_error_proto_rawDescData
}

var file_search_term_insight_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_search_term_insight_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_search_term_insight_error_proto_goTypes = []interface{}{
...
var file_search_term_insight_error_proto_depIdxs = []int32{
...
func init() { file_search_term_insight_error_proto_init() }
func file_search_term_insight_error_proto_init() {
	if File_search_term_insight_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_search_term_insight_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_search_term_insight_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_search_term_insight_error_proto_goTypes,
		DependencyIndexes: file_search_term_insight_error_proto_depIdxs,
		EnumInfos:         file_search_term_insight_error_proto_enumTypes,
		MessageInfos:      file_search_term_insight_error_proto_msgTypes,
	}.Build()
	File_search_term_insight_error_proto = out.File
	file_search_term_insight_error_proto_rawDesc = nil
	file_search_term_insight_error_proto_goTypes = nil
	file_search_term_insight_error_proto_depIdxs = nil
}
