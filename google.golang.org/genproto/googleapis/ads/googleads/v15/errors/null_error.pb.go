...
func (NullErrorEnum_NullError) Descriptor() protoreflect.EnumDescriptor {
	return file_null_error_proto_enumTypes[0].Descriptor()
}

func (NullErrorEnum_NullError) Type() protoreflect.EnumType {
	return &file_null_error_proto_enumTypes[0]
}
...
func (NullErrorEnum_NullError) EnumDescriptor() ([]byte, []int) {
	return file_null_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *NullErrorEnum) Reset() {
	*x = NullErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_null_error_proto_msgTypes[0]
...
func (*NullErrorEnum) Descriptor() ([]byte, []int) {
	return file_null_error_proto_rawDescGZIP(), []int{0}
}

var File_null_error_proto protoreflect.FileDescriptor

var file_null_error_proto_rawDesc = []byte{
	0x0a, 0x10, 0x6e, 0x75, 0x6c, 0x6c, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f,
...
var (
	file_null_error_proto_rawDescOnce sync.Once
	file_null_error_proto_rawDescData = file_null_error_proto_rawDesc
)

func file_null_error_proto_rawDescGZIP() []byte {
	file_null_error_proto_rawDescOnce.Do(func() {
		file_null_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_null_error_proto_rawDescData)
	})
	return file_null_error_proto_rawDescData
}

var file_null_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_null_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_null_error_proto_goTypes = []interface{}{
...
var file_null_error_proto_depIdxs = []int32{
...
func init() { file_null_error_proto_init() }
func file_null_error_proto_init() {
	if File_null_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_null_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_null_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_null_error_proto_goTypes,
		DependencyIndexes: file_null_error_proto_depIdxs,
		EnumInfos:         file_null_error_proto_enumTypes,
		MessageInfos:      file_null_error_proto_msgTypes,
	}.Build()
	File_null_error_proto = out.File
	file_null_error_proto_rawDesc = nil
	file_null_error_proto_goTypes = nil
	file_null_error_proto_depIdxs = nil
}
