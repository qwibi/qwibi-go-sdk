...
// 	protoc        v5.26.1
// source: new_resource_creation_error.proto
...
func (NewResourceCreationErrorEnum_NewResourceCreationError) Descriptor() protoreflect.EnumDescriptor {
	return file_new_resource_creation_error_proto_enumTypes[0].Descriptor()
}

func (NewResourceCreationErrorEnum_NewResourceCreationError) Type() protoreflect.EnumType {
	return &file_new_resource_creation_error_proto_enumTypes[0]
}
...
func (NewResourceCreationErrorEnum_NewResourceCreationError) EnumDescriptor() ([]byte, []int) {
	return file_new_resource_creation_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *NewResourceCreationErrorEnum) Reset() {
	*x = NewResourceCreationErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_new_resource_creation_error_proto_msgTypes[0]
...
func (*NewResourceCreationErrorEnum) Descriptor() ([]byte, []int) {
	return file_new_resource_creation_error_proto_rawDescGZIP(), []int{0}
}

var File_new_resource_creation_error_proto protoreflect.FileDescriptor

var file_new_resource_creation_error_proto_rawDesc = []byte{
	0x0a, 0x21, 0x6e, 0x65, 0x77, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x63,
...
var (
	file_new_resource_creation_error_proto_rawDescOnce sync.Once
	file_new_resource_creation_error_proto_rawDescData = file_new_resource_creation_error_proto_rawDesc
)

func file_new_resource_creation_error_proto_rawDescGZIP() []byte {
	file_new_resource_creation_error_proto_rawDescOnce.Do(func() {
		file_new_resource_creation_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_new_resource_creation_error_proto_rawDescData)
	})
	return file_new_resource_creation_error_proto_rawDescData
}

var file_new_resource_creation_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_new_resource_creation_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_new_resource_creation_error_proto_goTypes = []interface{}{
...
var file_new_resource_creation_error_proto_depIdxs = []int32{
...
func init() { file_new_resource_creation_error_proto_init() }
func file_new_resource_creation_error_proto_init() {
	if File_new_resource_creation_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_new_resource_creation_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_new_resource_creation_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_new_resource_creation_error_proto_goTypes,
		DependencyIndexes: file_new_resource_creation_error_proto_depIdxs,
		EnumInfos:         file_new_resource_creation_error_proto_enumTypes,
		MessageInfos:      file_new_resource_creation_error_proto_msgTypes,
	}.Build()
	File_new_resource_creation_error_proto = out.File
	file_new_resource_creation_error_proto_rawDesc = nil
	file_new_resource_creation_error_proto_goTypes = nil
	file_new_resource_creation_error_proto_depIdxs = nil
}
