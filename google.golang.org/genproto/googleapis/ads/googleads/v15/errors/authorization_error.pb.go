...
// 	protoc        v5.26.1
// source: authorization_error.proto
...
func (AuthorizationErrorEnum_AuthorizationError) Descriptor() protoreflect.EnumDescriptor {
	return file_authorization_error_proto_enumTypes[0].Descriptor()
}

func (AuthorizationErrorEnum_AuthorizationError) Type() protoreflect.EnumType {
	return &file_authorization_error_proto_enumTypes[0]
}
...
func (AuthorizationErrorEnum_AuthorizationError) EnumDescriptor() ([]byte, []int) {
	return file_authorization_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AuthorizationErrorEnum) Reset() {
	*x = AuthorizationErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_authorization_error_proto_msgTypes[0]
...
func (*AuthorizationErrorEnum) Descriptor() ([]byte, []int) {
	return file_authorization_error_proto_rawDescGZIP(), []int{0}
}

var File_authorization_error_proto protoreflect.FileDescriptor

var file_authorization_error_proto_rawDesc = []byte{
	0x0a, 0x19, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
...
var (
	file_authorization_error_proto_rawDescOnce sync.Once
	file_authorization_error_proto_rawDescData = file_authorization_error_proto_rawDesc
)

func file_authorization_error_proto_rawDescGZIP() []byte {
	file_authorization_error_proto_rawDescOnce.Do(func() {
		file_authorization_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_authorization_error_proto_rawDescData)
	})
	return file_authorization_error_proto_rawDescData
}

var file_authorization_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_authorization_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_authorization_error_proto_goTypes = []interface{}{
...
var file_authorization_error_proto_depIdxs = []int32{
...
func init() { file_authorization_error_proto_init() }
func file_authorization_error_proto_init() {
	if File_authorization_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_authorization_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_authorization_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_authorization_error_proto_goTypes,
		DependencyIndexes: file_authorization_error_proto_depIdxs,
		EnumInfos:         file_authorization_error_proto_enumTypes,
		MessageInfos:      file_authorization_error_proto_msgTypes,
	}.Build()
	File_authorization_error_proto = out.File
	file_authorization_error_proto_rawDesc = nil
	file_authorization_error_proto_goTypes = nil
	file_authorization_error_proto_depIdxs = nil
}
