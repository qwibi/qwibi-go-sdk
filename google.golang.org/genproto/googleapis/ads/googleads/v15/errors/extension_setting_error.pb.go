...
// 	protoc        v5.26.1
// source: extension_setting_error.proto
...
func (ExtensionSettingErrorEnum_ExtensionSettingError) Descriptor() protoreflect.EnumDescriptor {
	return file_extension_setting_error_proto_enumTypes[0].Descriptor()
}

func (ExtensionSettingErrorEnum_ExtensionSettingError) Type() protoreflect.EnumType {
	return &file_extension_setting_error_proto_enumTypes[0]
}
...
func (ExtensionSettingErrorEnum_ExtensionSettingError) EnumDescriptor() ([]byte, []int) {
	return file_extension_setting_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ExtensionSettingErrorEnum) Reset() {
	*x = ExtensionSettingErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_extension_setting_error_proto_msgTypes[0]
...
func (*ExtensionSettingErrorEnum) Descriptor() ([]byte, []int) {
	return file_extension_setting_error_proto_rawDescGZIP(), []int{0}
}

var File_extension_setting_error_proto protoreflect.FileDescriptor

var file_extension_setting_error_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x65, 0x74, 0x74,
...
var (
	file_extension_setting_error_proto_rawDescOnce sync.Once
	file_extension_setting_error_proto_rawDescData = file_extension_setting_error_proto_rawDesc
)

func file_extension_setting_error_proto_rawDescGZIP() []byte {
	file_extension_setting_error_proto_rawDescOnce.Do(func() {
		file_extension_setting_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_extension_setting_error_proto_rawDescData)
	})
	return file_extension_setting_error_proto_rawDescData
}

var file_extension_setting_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_extension_setting_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_extension_setting_error_proto_goTypes = []interface{}{
...
var file_extension_setting_error_proto_depIdxs = []int32{
...
func init() { file_extension_setting_error_proto_init() }
func file_extension_setting_error_proto_init() {
	if File_extension_setting_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_extension_setting_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_extension_setting_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_extension_setting_error_proto_goTypes,
		DependencyIndexes: file_extension_setting_error_proto_depIdxs,
		EnumInfos:         file_extension_setting_error_proto_enumTypes,
		MessageInfos:      file_extension_setting_error_proto_msgTypes,
	}.Build()
	File_extension_setting_error_proto = out.File
	file_extension_setting_error_proto_rawDesc = nil
	file_extension_setting_error_proto_goTypes = nil
	file_extension_setting_error_proto_depIdxs = nil
}
