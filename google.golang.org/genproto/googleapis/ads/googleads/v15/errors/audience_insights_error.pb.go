...
// 	protoc        v5.26.1
// source: audience_insights_error.proto
...
func (AudienceInsightsErrorEnum_AudienceInsightsError) Descriptor() protoreflect.EnumDescriptor {
	return file_audience_insights_error_proto_enumTypes[0].Descriptor()
}

func (AudienceInsightsErrorEnum_AudienceInsightsError) Type() protoreflect.EnumType {
	return &file_audience_insights_error_proto_enumTypes[0]
}
...
func (AudienceInsightsErrorEnum_AudienceInsightsError) EnumDescriptor() ([]byte, []int) {
	return file_audience_insights_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AudienceInsightsErrorEnum) Reset() {
	*x = AudienceInsightsErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_audience_insights_error_proto_msgTypes[0]
...
func (*AudienceInsightsErrorEnum) Descriptor() ([]byte, []int) {
	return file_audience_insights_error_proto_rawDescGZIP(), []int{0}
}

var File_audience_insights_error_proto protoreflect.FileDescriptor

var file_audience_insights_error_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x61, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x6e, 0x73, 0x69, 0x67,
...
var (
	file_audience_insights_error_proto_rawDescOnce sync.Once
	file_audience_insights_error_proto_rawDescData = file_audience_insights_error_proto_rawDesc
)

func file_audience_insights_error_proto_rawDescGZIP() []byte {
	file_audience_insights_error_proto_rawDescOnce.Do(func() {
		file_audience_insights_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_audience_insights_error_proto_rawDescData)
	})
	return file_audience_insights_error_proto_rawDescData
}

var file_audience_insights_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_audience_insights_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_audience_insights_error_proto_goTypes = []interface{}{
...
var file_audience_insights_error_proto_depIdxs = []int32{
...
func init() { file_audience_insights_error_proto_init() }
func file_audience_insights_error_proto_init() {
	if File_audience_insights_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_audience_insights_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_audience_insights_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_audience_insights_error_proto_goTypes,
		DependencyIndexes: file_audience_insights_error_proto_depIdxs,
		EnumInfos:         file_audience_insights_error_proto_enumTypes,
		MessageInfos:      file_audience_insights_error_proto_msgTypes,
	}.Build()
	File_audience_insights_error_proto = out.File
	file_audience_insights_error_proto_rawDesc = nil
	file_audience_insights_error_proto_goTypes = nil
	file_audience_insights_error_proto_depIdxs = nil
}
