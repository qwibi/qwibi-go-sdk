...
func (BiddingErrorEnum_BiddingError) Descriptor() protoreflect.EnumDescriptor {
	return file_bidding_error_proto_enumTypes[0].Descriptor()
}

func (BiddingErrorEnum_BiddingError) Type() protoreflect.EnumType {
	return &file_bidding_error_proto_enumTypes[0]
}
...
func (BiddingErrorEnum_BiddingError) EnumDescriptor() ([]byte, []int) {
	return file_bidding_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BiddingErrorEnum) Reset() {
	*x = BiddingErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_bidding_error_proto_msgTypes[0]
...
func (*BiddingErrorEnum) Descriptor() ([]byte, []int) {
	return file_bidding_error_proto_rawDescGZIP(), []int{0}
}

var File_bidding_error_proto protoreflect.FileDescriptor

var file_bidding_error_proto_rawDesc = []byte{
	0x0a, 0x13, 0x62, 0x69, 0x64, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e,
...
var (
	file_bidding_error_proto_rawDescOnce sync.Once
	file_bidding_error_proto_rawDescData = file_bidding_error_proto_rawDesc
)

func file_bidding_error_proto_rawDescGZIP() []byte {
	file_bidding_error_proto_rawDescOnce.Do(func() {
		file_bidding_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_bidding_error_proto_rawDescData)
	})
	return file_bidding_error_proto_rawDescData
}

var file_bidding_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_bidding_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_bidding_error_proto_goTypes = []interface{}{
...
var file_bidding_error_proto_depIdxs = []int32{
...
func init() { file_bidding_error_proto_init() }
func file_bidding_error_proto_init() {
	if File_bidding_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_bidding_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_bidding_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_bidding_error_proto_goTypes,
		DependencyIndexes: file_bidding_error_proto_depIdxs,
		EnumInfos:         file_bidding_error_proto_enumTypes,
		MessageInfos:      file_bidding_error_proto_msgTypes,
	}.Build()
	File_bidding_error_proto = out.File
	file_bidding_error_proto_rawDesc = nil
	file_bidding_error_proto_goTypes = nil
	file_bidding_error_proto_depIdxs = nil
}
