...
func (DateRangeErrorEnum_DateRangeError) Descriptor() protoreflect.EnumDescriptor {
	return file_date_range_error_proto_enumTypes[0].Descriptor()
}

func (DateRangeErrorEnum_DateRangeError) Type() protoreflect.EnumType {
	return &file_date_range_error_proto_enumTypes[0]
}
...
func (DateRangeErrorEnum_DateRangeError) EnumDescriptor() ([]byte, []int) {
	return file_date_range_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *DateRangeErrorEnum) Reset() {
	*x = DateRangeErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_date_range_error_proto_msgTypes[0]
...
func (*DateRangeErrorEnum) Descriptor() ([]byte, []int) {
	return file_date_range_error_proto_rawDescGZIP(), []int{0}
}

var File_date_range_error_proto protoreflect.FileDescriptor

var file_date_range_error_proto_rawDesc = []byte{
	0x0a, 0x16, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x65, 0x72, 0x72,
...
var (
	file_date_range_error_proto_rawDescOnce sync.Once
	file_date_range_error_proto_rawDescData = file_date_range_error_proto_rawDesc
)

func file_date_range_error_proto_rawDescGZIP() []byte {
	file_date_range_error_proto_rawDescOnce.Do(func() {
		file_date_range_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_date_range_error_proto_rawDescData)
	})
	return file_date_range_error_proto_rawDescData
}

var file_date_range_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_date_range_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_date_range_error_proto_goTypes = []interface{}{
...
var file_date_range_error_proto_depIdxs = []int32{
...
func init() { file_date_range_error_proto_init() }
func file_date_range_error_proto_init() {
	if File_date_range_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_date_range_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_date_range_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_date_range_error_proto_goTypes,
		DependencyIndexes: file_date_range_error_proto_depIdxs,
		EnumInfos:         file_date_range_error_proto_enumTypes,
		MessageInfos:      file_date_range_error_proto_msgTypes,
	}.Build()
	File_date_range_error_proto = out.File
	file_date_range_error_proto_rawDesc = nil
	file_date_range_error_proto_goTypes = nil
	file_date_range_error_proto_depIdxs = nil
}
