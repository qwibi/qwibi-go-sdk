...
func (IdErrorEnum_IdError) Descriptor() protoreflect.EnumDescriptor {
	return file_id_error_proto_enumTypes[0].Descriptor()
}

func (IdErrorEnum_IdError) Type() protoreflect.EnumType {
	return &file_id_error_proto_enumTypes[0]
}
...
func (IdErrorEnum_IdError) EnumDescriptor() ([]byte, []int) {
	return file_id_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *IdErrorEnum) Reset() {
	*x = IdErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_id_error_proto_msgTypes[0]
...
func (*IdErrorEnum) Descriptor() ([]byte, []int) {
	return file_id_error_proto_rawDescGZIP(), []int{0}
}

var File_id_error_proto protoreflect.FileDescriptor

var file_id_error_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x69, 0x64, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_id_error_proto_rawDescOnce sync.Once
	file_id_error_proto_rawDescData = file_id_error_proto_rawDesc
)

func file_id_error_proto_rawDescGZIP() []byte {
	file_id_error_proto_rawDescOnce.Do(func() {
		file_id_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_id_error_proto_rawDescData)
	})
	return file_id_error_proto_rawDescData
}

var file_id_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_id_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_id_error_proto_goTypes = []interface{}{
...
var file_id_error_proto_depIdxs = []int32{
...
func init() { file_id_error_proto_init() }
func file_id_error_proto_init() {
	if File_id_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_id_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_id_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_id_error_proto_goTypes,
		DependencyIndexes: file_id_error_proto_depIdxs,
		EnumInfos:         file_id_error_proto_enumTypes,
		MessageInfos:      file_id_error_proto_msgTypes,
	}.Build()
	File_id_error_proto = out.File
	file_id_error_proto_rawDesc = nil
	file_id_error_proto_goTypes = nil
	file_id_error_proto_depIdxs = nil
}
