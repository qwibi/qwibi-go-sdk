...
func (SharedSetErrorEnum_SharedSetError) Descriptor() protoreflect.EnumDescriptor {
	return file_shared_set_error_proto_enumTypes[0].Descriptor()
}

func (SharedSetErrorEnum_SharedSetError) Type() protoreflect.EnumType {
	return &file_shared_set_error_proto_enumTypes[0]
}
...
func (SharedSetErrorEnum_SharedSetError) EnumDescriptor() ([]byte, []int) {
	return file_shared_set_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SharedSetErrorEnum) Reset() {
	*x = SharedSetErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shared_set_error_proto_msgTypes[0]
...
func (*SharedSetErrorEnum) Descriptor() ([]byte, []int) {
	return file_shared_set_error_proto_rawDescGZIP(), []int{0}
}

var File_shared_set_error_proto protoreflect.FileDescriptor

var file_shared_set_error_proto_rawDesc = []byte{
	0x0a, 0x16, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x5f, 0x73, 0x65, 0x74, 0x5f, 0x65, 0x72, 0x72,
...
var (
	file_shared_set_error_proto_rawDescOnce sync.Once
	file_shared_set_error_proto_rawDescData = file_shared_set_error_proto_rawDesc
)

func file_shared_set_error_proto_rawDescGZIP() []byte {
	file_shared_set_error_proto_rawDescOnce.Do(func() {
		file_shared_set_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_shared_set_error_proto_rawDescData)
	})
	return file_shared_set_error_proto_rawDescData
}

var file_shared_set_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_shared_set_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_shared_set_error_proto_goTypes = []interface{}{
...
var file_shared_set_error_proto_depIdxs = []int32{
...
func init() { file_shared_set_error_proto_init() }
func file_shared_set_error_proto_init() {
	if File_shared_set_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_shared_set_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_shared_set_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_shared_set_error_proto_goTypes,
		DependencyIndexes: file_shared_set_error_proto_depIdxs,
		EnumInfos:         file_shared_set_error_proto_enumTypes,
		MessageInfos:      file_shared_set_error_proto_msgTypes,
	}.Build()
	File_shared_set_error_proto = out.File
	file_shared_set_error_proto_rawDesc = nil
	file_shared_set_error_proto_goTypes = nil
	file_shared_set_error_proto_depIdxs = nil
}
