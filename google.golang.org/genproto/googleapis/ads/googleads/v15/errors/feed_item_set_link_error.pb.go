...
// 	protoc        v5.26.1
// source: feed_item_set_link_error.proto
...
func (FeedItemSetLinkErrorEnum_FeedItemSetLinkError) Descriptor() protoreflect.EnumDescriptor {
	return file_feed_item_set_link_error_proto_enumTypes[0].Descriptor()
}

func (FeedItemSetLinkErrorEnum_FeedItemSetLinkError) Type() protoreflect.EnumType {
	return &file_feed_item_set_link_error_proto_enumTypes[0]
}
...
func (FeedItemSetLinkErrorEnum_FeedItemSetLinkError) EnumDescriptor() ([]byte, []int) {
	return file_feed_item_set_link_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *FeedItemSetLinkErrorEnum) Reset() {
	*x = FeedItemSetLinkErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_feed_item_set_link_error_proto_msgTypes[0]
...
func (*FeedItemSetLinkErrorEnum) Descriptor() ([]byte, []int) {
	return file_feed_item_set_link_error_proto_rawDescGZIP(), []int{0}
}

var File_feed_item_set_link_error_proto protoreflect.FileDescriptor

var file_feed_item_set_link_error_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x73, 0x65, 0x74, 0x5f,
...
var (
	file_feed_item_set_link_error_proto_rawDescOnce sync.Once
	file_feed_item_set_link_error_proto_rawDescData = file_feed_item_set_link_error_proto_rawDesc
)

func file_feed_item_set_link_error_proto_rawDescGZIP() []byte {
	file_feed_item_set_link_error_proto_rawDescOnce.Do(func() {
		file_feed_item_set_link_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_feed_item_set_link_error_proto_rawDescData)
	})
	return file_feed_item_set_link_error_proto_rawDescData
}

var file_feed_item_set_link_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_feed_item_set_link_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_feed_item_set_link_error_proto_goTypes = []interface{}{
...
var file_feed_item_set_link_error_proto_depIdxs = []int32{
...
func init() { file_feed_item_set_link_error_proto_init() }
func file_feed_item_set_link_error_proto_init() {
	if File_feed_item_set_link_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_feed_item_set_link_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_feed_item_set_link_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_feed_item_set_link_error_proto_goTypes,
		DependencyIndexes: file_feed_item_set_link_error_proto_depIdxs,
		EnumInfos:         file_feed_item_set_link_error_proto_enumTypes,
		MessageInfos:      file_feed_item_set_link_error_proto_msgTypes,
	}.Build()
	File_feed_item_set_link_error_proto = out.File
	file_feed_item_set_link_error_proto_rawDesc = nil
	file_feed_item_set_link_error_proto_goTypes = nil
	file_feed_item_set_link_error_proto_depIdxs = nil
}
