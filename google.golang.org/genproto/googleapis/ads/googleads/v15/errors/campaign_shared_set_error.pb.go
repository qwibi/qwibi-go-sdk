...
// 	protoc        v5.26.1
// source: campaign_shared_set_error.proto
...
func (CampaignSharedSetErrorEnum_CampaignSharedSetError) Descriptor() protoreflect.EnumDescriptor {
	return file_campaign_shared_set_error_proto_enumTypes[0].Descriptor()
}

func (CampaignSharedSetErrorEnum_CampaignSharedSetError) Type() protoreflect.EnumType {
	return &file_campaign_shared_set_error_proto_enumTypes[0]
}
...
func (CampaignSharedSetErrorEnum_CampaignSharedSetError) EnumDescriptor() ([]byte, []int) {
	return file_campaign_shared_set_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CampaignSharedSetErrorEnum) Reset() {
	*x = CampaignSharedSetErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_campaign_shared_set_error_proto_msgTypes[0]
...
func (*CampaignSharedSetErrorEnum) Descriptor() ([]byte, []int) {
	return file_campaign_shared_set_error_proto_rawDescGZIP(), []int{0}
}

var File_campaign_shared_set_error_proto protoreflect.FileDescriptor

var file_campaign_shared_set_error_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x65,
...
var (
	file_campaign_shared_set_error_proto_rawDescOnce sync.Once
	file_campaign_shared_set_error_proto_rawDescData = file_campaign_shared_set_error_proto_rawDesc
)

func file_campaign_shared_set_error_proto_rawDescGZIP() []byte {
	file_campaign_shared_set_error_proto_rawDescOnce.Do(func() {
		file_campaign_shared_set_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_campaign_shared_set_error_proto_rawDescData)
	})
	return file_campaign_shared_set_error_proto_rawDescData
}

var file_campaign_shared_set_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_campaign_shared_set_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_campaign_shared_set_error_proto_goTypes = []interface{}{
...
var file_campaign_shared_set_error_proto_depIdxs = []int32{
...
func init() { file_campaign_shared_set_error_proto_init() }
func file_campaign_shared_set_error_proto_init() {
	if File_campaign_shared_set_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_campaign_shared_set_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_campaign_shared_set_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_campaign_shared_set_error_proto_goTypes,
		DependencyIndexes: file_campaign_shared_set_error_proto_depIdxs,
		EnumInfos:         file_campaign_shared_set_error_proto_enumTypes,
		MessageInfos:      file_campaign_shared_set_error_proto_msgTypes,
	}.Build()
	File_campaign_shared_set_error_proto = out.File
	file_campaign_shared_set_error_proto_rawDesc = nil
	file_campaign_shared_set_error_proto_goTypes = nil
	file_campaign_shared_set_error_proto_depIdxs = nil
}
