...
func (AdxErrorEnum_AdxError) Descriptor() protoreflect.EnumDescriptor {
	return file_adx_error_proto_enumTypes[0].Descriptor()
}

func (AdxErrorEnum_AdxError) Type() protoreflect.EnumType {
	return &file_adx_error_proto_enumTypes[0]
}
...
func (AdxErrorEnum_AdxError) EnumDescriptor() ([]byte, []int) {
	return file_adx_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AdxErrorEnum) Reset() {
	*x = AdxErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_adx_error_proto_msgTypes[0]
...
func (*AdxErrorEnum) Descriptor() ([]byte, []int) {
	return file_adx_error_proto_rawDescGZIP(), []int{0}
}

var File_adx_error_proto protoreflect.FileDescriptor

var file_adx_error_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x61, 0x64, 0x78, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74,
...
var (
	file_adx_error_proto_rawDescOnce sync.Once
	file_adx_error_proto_rawDescData = file_adx_error_proto_rawDesc
)

func file_adx_error_proto_rawDescGZIP() []byte {
	file_adx_error_proto_rawDescOnce.Do(func() {
		file_adx_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_adx_error_proto_rawDescData)
	})
	return file_adx_error_proto_rawDescData
}

var file_adx_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_adx_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_adx_error_proto_goTypes = []interface{}{
...
var file_adx_error_proto_depIdxs = []int32{
...
func init() { file_adx_error_proto_init() }
func file_adx_error_proto_init() {
	if File_adx_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_adx_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_adx_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_adx_error_proto_goTypes,
		DependencyIndexes: file_adx_error_proto_depIdxs,
		EnumInfos:         file_adx_error_proto_enumTypes,
		MessageInfos:      file_adx_error_proto_msgTypes,
	}.Build()
	File_adx_error_proto = out.File
	file_adx_error_proto_rawDesc = nil
	file_adx_error_proto_goTypes = nil
	file_adx_error_proto_depIdxs = nil
}
