...
// 	protoc        v5.26.1
// source: access_invitation_error.proto
...
func (AccessInvitationErrorEnum_AccessInvitationError) Descriptor() protoreflect.EnumDescriptor {
	return file_access_invitation_error_proto_enumTypes[0].Descriptor()
}

func (AccessInvitationErrorEnum_AccessInvitationError) Type() protoreflect.EnumType {
	return &file_access_invitation_error_proto_enumTypes[0]
}
...
func (AccessInvitationErrorEnum_AccessInvitationError) EnumDescriptor() ([]byte, []int) {
	return file_access_invitation_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AccessInvitationErrorEnum) Reset() {
	*x = AccessInvitationErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_access_invitation_error_proto_msgTypes[0]
...
func (*AccessInvitationErrorEnum) Descriptor() ([]byte, []int) {
	return file_access_invitation_error_proto_rawDescGZIP(), []int{0}
}

var File_access_invitation_error_proto protoreflect.FileDescriptor

var file_access_invitation_error_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74,
...
var (
	file_access_invitation_error_proto_rawDescOnce sync.Once
	file_access_invitation_error_proto_rawDescData = file_access_invitation_error_proto_rawDesc
)

func file_access_invitation_error_proto_rawDescGZIP() []byte {
	file_access_invitation_error_proto_rawDescOnce.Do(func() {
		file_access_invitation_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_access_invitation_error_proto_rawDescData)
	})
	return file_access_invitation_error_proto_rawDescData
}

var file_access_invitation_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_access_invitation_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_access_invitation_error_proto_goTypes = []interface{}{
...
var file_access_invitation_error_proto_depIdxs = []int32{
...
func init() { file_access_invitation_error_proto_init() }
func file_access_invitation_error_proto_init() {
	if File_access_invitation_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_access_invitation_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_access_invitation_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_access_invitation_error_proto_goTypes,
		DependencyIndexes: file_access_invitation_error_proto_depIdxs,
		EnumInfos:         file_access_invitation_error_proto_enumTypes,
		MessageInfos:      file_access_invitation_error_proto_msgTypes,
	}.Build()
	File_access_invitation_error_proto = out.File
	file_access_invitation_error_proto_rawDesc = nil
	file_access_invitation_error_proto_goTypes = nil
	file_access_invitation_error_proto_depIdxs = nil
}
