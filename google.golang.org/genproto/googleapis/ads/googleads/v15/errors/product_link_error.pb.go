...
// 	protoc        v5.26.1
// source: product_link_error.proto
...
func (ProductLinkErrorEnum_ProductLinkError) Descriptor() protoreflect.EnumDescriptor {
	return file_product_link_error_proto_enumTypes[0].Descriptor()
}

func (ProductLinkErrorEnum_ProductLinkError) Type() protoreflect.EnumType {
	return &file_product_link_error_proto_enumTypes[0]
}
...
func (ProductLinkErrorEnum_ProductLinkError) EnumDescriptor() ([]byte, []int) {
	return file_product_link_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ProductLinkErrorEnum) Reset() {
	*x = ProductLinkErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_product_link_error_proto_msgTypes[0]
...
func (*ProductLinkErrorEnum) Descriptor() ([]byte, []int) {
	return file_product_link_error_proto_rawDescGZIP(), []int{0}
}

var File_product_link_error_proto protoreflect.FileDescriptor

var file_product_link_error_proto_rawDesc = []byte{
	0x0a, 0x18, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x5f, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x65,
...
var (
	file_product_link_error_proto_rawDescOnce sync.Once
	file_product_link_error_proto_rawDescData = file_product_link_error_proto_rawDesc
)

func file_product_link_error_proto_rawDescGZIP() []byte {
	file_product_link_error_proto_rawDescOnce.Do(func() {
		file_product_link_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_product_link_error_proto_rawDescData)
	})
	return file_product_link_error_proto_rawDescData
}

var file_product_link_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_product_link_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_product_link_error_proto_goTypes = []interface{}{
...
var file_product_link_error_proto_depIdxs = []int32{
...
func init() { file_product_link_error_proto_init() }
func file_product_link_error_proto_init() {
	if File_product_link_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_product_link_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_product_link_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_product_link_error_proto_goTypes,
		DependencyIndexes: file_product_link_error_proto_depIdxs,
		EnumInfos:         file_product_link_error_proto_enumTypes,
		MessageInfos:      file_product_link_error_proto_msgTypes,
	}.Build()
	File_product_link_error_proto = out.File
	file_product_link_error_proto_rawDesc = nil
	file_product_link_error_proto_goTypes = nil
	file_product_link_error_proto_depIdxs = nil
}
