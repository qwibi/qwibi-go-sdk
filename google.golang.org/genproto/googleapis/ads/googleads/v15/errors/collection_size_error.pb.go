...
// 	protoc        v5.26.1
// source: collection_size_error.proto
...
func (CollectionSizeErrorEnum_CollectionSizeError) Descriptor() protoreflect.EnumDescriptor {
	return file_collection_size_error_proto_enumTypes[0].Descriptor()
}

func (CollectionSizeErrorEnum_CollectionSizeError) Type() protoreflect.EnumType {
	return &file_collection_size_error_proto_enumTypes[0]
}
...
func (CollectionSizeErrorEnum_CollectionSizeError) EnumDescriptor() ([]byte, []int) {
	return file_collection_size_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CollectionSizeErrorEnum) Reset() {
	*x = CollectionSizeErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_collection_size_error_proto_msgTypes[0]
...
func (*CollectionSizeErrorEnum) Descriptor() ([]byte, []int) {
	return file_collection_size_error_proto_rawDescGZIP(), []int{0}
}

var File_collection_size_error_proto protoreflect.FileDescriptor

var file_collection_size_error_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69, 0x7a,
...
var (
	file_collection_size_error_proto_rawDescOnce sync.Once
	file_collection_size_error_proto_rawDescData = file_collection_size_error_proto_rawDesc
)

func file_collection_size_error_proto_rawDescGZIP() []byte {
	file_collection_size_error_proto_rawDescOnce.Do(func() {
		file_collection_size_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_collection_size_error_proto_rawDescData)
	})
	return file_collection_size_error_proto_rawDescData
}

var file_collection_size_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_collection_size_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_collection_size_error_proto_goTypes = []interface{}{
...
var file_collection_size_error_proto_depIdxs = []int32{
...
func init() { file_collection_size_error_proto_init() }
func file_collection_size_error_proto_init() {
	if File_collection_size_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_collection_size_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_collection_size_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_collection_size_error_proto_goTypes,
		DependencyIndexes: file_collection_size_error_proto_depIdxs,
		EnumInfos:         file_collection_size_error_proto_enumTypes,
		MessageInfos:      file_collection_size_error_proto_msgTypes,
	}.Build()
	File_collection_size_error_proto = out.File
	file_collection_size_error_proto_rawDesc = nil
	file_collection_size_error_proto_goTypes = nil
	file_collection_size_error_proto_depIdxs = nil
}
