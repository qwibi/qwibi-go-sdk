...
// 	protoc        v5.26.1
// source: country_code_error.proto
...
func (CountryCodeErrorEnum_CountryCodeError) Descriptor() protoreflect.EnumDescriptor {
	return file_country_code_error_proto_enumTypes[0].Descriptor()
}

func (CountryCodeErrorEnum_CountryCodeError) Type() protoreflect.EnumType {
	return &file_country_code_error_proto_enumTypes[0]
}
...
func (CountryCodeErrorEnum_CountryCodeError) EnumDescriptor() ([]byte, []int) {
	return file_country_code_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CountryCodeErrorEnum) Reset() {
	*x = CountryCodeErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_country_code_error_proto_msgTypes[0]
...
func (*CountryCodeErrorEnum) Descriptor() ([]byte, []int) {
	return file_country_code_error_proto_rawDescGZIP(), []int{0}
}

var File_country_code_error_proto protoreflect.FileDescriptor

var file_country_code_error_proto_rawDesc = []byte{
	0x0a, 0x18, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x5f, 0x65,
...
var (
	file_country_code_error_proto_rawDescOnce sync.Once
	file_country_code_error_proto_rawDescData = file_country_code_error_proto_rawDesc
)

func file_country_code_error_proto_rawDescGZIP() []byte {
	file_country_code_error_proto_rawDescOnce.Do(func() {
		file_country_code_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_country_code_error_proto_rawDescData)
	})
	return file_country_code_error_proto_rawDescData
}

var file_country_code_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_country_code_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_country_code_error_proto_goTypes = []interface{}{
...
var file_country_code_error_proto_depIdxs = []int32{
...
func init() { file_country_code_error_proto_init() }
func file_country_code_error_proto_init() {
	if File_country_code_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_country_code_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_country_code_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_country_code_error_proto_goTypes,
		DependencyIndexes: file_country_code_error_proto_depIdxs,
		EnumInfos:         file_country_code_error_proto_enumTypes,
		MessageInfos:      file_country_code_error_proto_msgTypes,
	}.Build()
	File_country_code_error_proto = out.File
	file_country_code_error_proto_rawDesc = nil
	file_country_code_error_proto_goTypes = nil
	file_country_code_error_proto_depIdxs = nil
}
