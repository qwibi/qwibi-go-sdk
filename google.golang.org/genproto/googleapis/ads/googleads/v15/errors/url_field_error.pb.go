...
func (UrlFieldErrorEnum_UrlFieldError) Descriptor() protoreflect.EnumDescriptor {
	return file_url_field_error_proto_enumTypes[0].Descriptor()
}

func (UrlFieldErrorEnum_UrlFieldError) Type() protoreflect.EnumType {
	return &file_url_field_error_proto_enumTypes[0]
}
...
func (UrlFieldErrorEnum_UrlFieldError) EnumDescriptor() ([]byte, []int) {
	return file_url_field_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *UrlFieldErrorEnum) Reset() {
	*x = UrlFieldErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_url_field_error_proto_msgTypes[0]
...
func (*UrlFieldErrorEnum) Descriptor() ([]byte, []int) {
	return file_url_field_error_proto_rawDescGZIP(), []int{0}
}

var File_url_field_error_proto protoreflect.FileDescriptor

var file_url_field_error_proto_rawDesc = []byte{
	0x0a, 0x15, 0x75, 0x72, 0x6c, 0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x65, 0x72, 0x72, 0x6f,
...
var (
	file_url_field_error_proto_rawDescOnce sync.Once
	file_url_field_error_proto_rawDescData = file_url_field_error_proto_rawDesc
)

func file_url_field_error_proto_rawDescGZIP() []byte {
	file_url_field_error_proto_rawDescOnce.Do(func() {
		file_url_field_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_url_field_error_proto_rawDescData)
	})
	return file_url_field_error_proto_rawDescData
}

var file_url_field_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_url_field_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_url_field_error_proto_goTypes = []interface{}{
...
var file_url_field_error_proto_depIdxs = []int32{
...
func init() { file_url_field_error_proto_init() }
func file_url_field_error_proto_init() {
	if File_url_field_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_url_field_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_url_field_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_url_field_error_proto_goTypes,
		DependencyIndexes: file_url_field_error_proto_depIdxs,
		EnumInfos:         file_url_field_error_proto_enumTypes,
		MessageInfos:      file_url_field_error_proto_msgTypes,
	}.Build()
	File_url_field_error_proto = out.File
	file_url_field_error_proto_rawDesc = nil
	file_url_field_error_proto_goTypes = nil
	file_url_field_error_proto_depIdxs = nil
}
