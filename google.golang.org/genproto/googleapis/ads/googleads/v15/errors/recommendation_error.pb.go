...
// 	protoc        v5.26.1
// source: recommendation_error.proto
...
func (RecommendationErrorEnum_RecommendationError) Descriptor() protoreflect.EnumDescriptor {
	return file_recommendation_error_proto_enumTypes[0].Descriptor()
}

func (RecommendationErrorEnum_RecommendationError) Type() protoreflect.EnumType {
	return &file_recommendation_error_proto_enumTypes[0]
}
...
func (RecommendationErrorEnum_RecommendationError) EnumDescriptor() ([]byte, []int) {
	return file_recommendation_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *RecommendationErrorEnum) Reset() {
	*x = RecommendationErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_recommendation_error_proto_msgTypes[0]
...
func (*RecommendationErrorEnum) Descriptor() ([]byte, []int) {
	return file_recommendation_error_proto_rawDescGZIP(), []int{0}
}

var File_recommendation_error_proto protoreflect.FileDescriptor

var file_recommendation_error_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x72, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e,
...
var (
	file_recommendation_error_proto_rawDescOnce sync.Once
	file_recommendation_error_proto_rawDescData = file_recommendation_error_proto_rawDesc
)

func file_recommendation_error_proto_rawDescGZIP() []byte {
	file_recommendation_error_proto_rawDescOnce.Do(func() {
		file_recommendation_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_recommendation_error_proto_rawDescData)
	})
	return file_recommendation_error_proto_rawDescData
}

var file_recommendation_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_recommendation_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_recommendation_error_proto_goTypes = []interface{}{
...
var file_recommendation_error_proto_depIdxs = []int32{
...
func init() { file_recommendation_error_proto_init() }
func file_recommendation_error_proto_init() {
	if File_recommendation_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_recommendation_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_recommendation_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_recommendation_error_proto_goTypes,
		DependencyIndexes: file_recommendation_error_proto_depIdxs,
		EnumInfos:         file_recommendation_error_proto_enumTypes,
		MessageInfos:      file_recommendation_error_proto_msgTypes,
	}.Build()
	File_recommendation_error_proto = out.File
	file_recommendation_error_proto_rawDesc = nil
	file_recommendation_error_proto_goTypes = nil
	file_recommendation_error_proto_depIdxs = nil
}
