...
// 	protoc        v5.26.1
// source: asset_group_error.proto
...
func (AssetGroupErrorEnum_AssetGroupError) Descriptor() protoreflect.EnumDescriptor {
	return file_asset_group_error_proto_enumTypes[0].Descriptor()
}

func (AssetGroupErrorEnum_AssetGroupError) Type() protoreflect.EnumType {
	return &file_asset_group_error_proto_enumTypes[0]
}
...
func (AssetGroupErrorEnum_AssetGroupError) EnumDescriptor() ([]byte, []int) {
	return file_asset_group_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AssetGroupErrorEnum) Reset() {
	*x = AssetGroupErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_asset_group_error_proto_msgTypes[0]
...
func (*AssetGroupErrorEnum) Descriptor() ([]byte, []int) {
	return file_asset_group_error_proto_rawDescGZIP(), []int{0}
}

var File_asset_group_error_proto protoreflect.FileDescriptor

var file_asset_group_error_proto_rawDesc = []byte{
	0x0a, 0x17, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x65, 0x72,
...
var (
	file_asset_group_error_proto_rawDescOnce sync.Once
	file_asset_group_error_proto_rawDescData = file_asset_group_error_proto_rawDesc
)

func file_asset_group_error_proto_rawDescGZIP() []byte {
	file_asset_group_error_proto_rawDescOnce.Do(func() {
		file_asset_group_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_asset_group_error_proto_rawDescData)
	})
	return file_asset_group_error_proto_rawDescData
}

var file_asset_group_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_asset_group_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_asset_group_error_proto_goTypes = []interface{}{
...
var file_asset_group_error_proto_depIdxs = []int32{
...
func init() { file_asset_group_error_proto_init() }
func file_asset_group_error_proto_init() {
	if File_asset_group_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_asset_group_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_asset_group_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_asset_group_error_proto_goTypes,
		DependencyIndexes: file_asset_group_error_proto_depIdxs,
		EnumInfos:         file_asset_group_error_proto_enumTypes,
		MessageInfos:      file_asset_group_error_proto_msgTypes,
	}.Build()
	File_asset_group_error_proto = out.File
	file_asset_group_error_proto_rawDesc = nil
	file_asset_group_error_proto_goTypes = nil
	file_asset_group_error_proto_depIdxs = nil
}
