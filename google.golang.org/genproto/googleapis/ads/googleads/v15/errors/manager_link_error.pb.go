...
// 	protoc        v5.26.1
// source: manager_link_error.proto
...
func (ManagerLinkErrorEnum_ManagerLinkError) Descriptor() protoreflect.EnumDescriptor {
	return file_manager_link_error_proto_enumTypes[0].Descriptor()
}

func (ManagerLinkErrorEnum_ManagerLinkError) Type() protoreflect.EnumType {
	return &file_manager_link_error_proto_enumTypes[0]
}
...
func (ManagerLinkErrorEnum_ManagerLinkError) EnumDescriptor() ([]byte, []int) {
	return file_manager_link_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ManagerLinkErrorEnum) Reset() {
	*x = ManagerLinkErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_manager_link_error_proto_msgTypes[0]
...
func (*ManagerLinkErrorEnum) Descriptor() ([]byte, []int) {
	return file_manager_link_error_proto_rawDescGZIP(), []int{0}
}

var File_manager_link_error_proto protoreflect.FileDescriptor

var file_manager_link_error_proto_rawDesc = []byte{
	0x0a, 0x18, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x65,
...
var (
	file_manager_link_error_proto_rawDescOnce sync.Once
	file_manager_link_error_proto_rawDescData = file_manager_link_error_proto_rawDesc
)

func file_manager_link_error_proto_rawDescGZIP() []byte {
	file_manager_link_error_proto_rawDescOnce.Do(func() {
		file_manager_link_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_manager_link_error_proto_rawDescData)
	})
	return file_manager_link_error_proto_rawDescData
}

var file_manager_link_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_manager_link_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_manager_link_error_proto_goTypes = []interface{}{
...
var file_manager_link_error_proto_depIdxs = []int32{
...
func init() { file_manager_link_error_proto_init() }
func file_manager_link_error_proto_init() {
	if File_manager_link_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_manager_link_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_manager_link_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_manager_link_error_proto_goTypes,
		DependencyIndexes: file_manager_link_error_proto_depIdxs,
		EnumInfos:         file_manager_link_error_proto_enumTypes,
		MessageInfos:      file_manager_link_error_proto_msgTypes,
	}.Build()
	File_manager_link_error_proto = out.File
	file_manager_link_error_proto_rawDesc = nil
	file_manager_link_error_proto_goTypes = nil
	file_manager_link_error_proto_depIdxs = nil
}
