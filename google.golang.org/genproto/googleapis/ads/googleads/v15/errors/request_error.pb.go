...
func (RequestErrorEnum_RequestError) Descriptor() protoreflect.EnumDescriptor {
	return file_request_error_proto_enumTypes[0].Descriptor()
}

func (RequestErrorEnum_RequestError) Type() protoreflect.EnumType {
	return &file_request_error_proto_enumTypes[0]
}
...
func (RequestErrorEnum_RequestError) EnumDescriptor() ([]byte, []int) {
	return file_request_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *RequestErrorEnum) Reset() {
	*x = RequestErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_request_error_proto_msgTypes[0]
...
func (*RequestErrorEnum) Descriptor() ([]byte, []int) {
	return file_request_error_proto_rawDescGZIP(), []int{0}
}

var File_request_error_proto protoreflect.FileDescriptor

var file_request_error_proto_rawDesc = []byte{
	0x0a, 0x13, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e,
...
var (
	file_request_error_proto_rawDescOnce sync.Once
	file_request_error_proto_rawDescData = file_request_error_proto_rawDesc
)

func file_request_error_proto_rawDescGZIP() []byte {
	file_request_error_proto_rawDescOnce.Do(func() {
		file_request_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_request_error_proto_rawDescData)
	})
	return file_request_error_proto_rawDescData
}

var file_request_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_request_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_request_error_proto_goTypes = []interface{}{
...
var file_request_error_proto_depIdxs = []int32{
...
func init() { file_request_error_proto_init() }
func file_request_error_proto_init() {
	if File_request_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_request_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_request_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_request_error_proto_goTypes,
		DependencyIndexes: file_request_error_proto_depIdxs,
		EnumInfos:         file_request_error_proto_enumTypes,
		MessageInfos:      file_request_error_proto_msgTypes,
	}.Build()
	File_request_error_proto = out.File
	file_request_error_proto_rawDesc = nil
	file_request_error_proto_goTypes = nil
	file_request_error_proto_depIdxs = nil
}
