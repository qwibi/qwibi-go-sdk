...
func (MultiplierErrorEnum_MultiplierError) Descriptor() protoreflect.EnumDescriptor {
	return file_multiplier_error_proto_enumTypes[0].Descriptor()
}

func (MultiplierErrorEnum_MultiplierError) Type() protoreflect.EnumType {
	return &file_multiplier_error_proto_enumTypes[0]
}
...
func (MultiplierErrorEnum_MultiplierError) EnumDescriptor() ([]byte, []int) {
	return file_multiplier_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *MultiplierErrorEnum) Reset() {
	*x = MultiplierErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_multiplier_error_proto_msgTypes[0]
...
func (*MultiplierErrorEnum) Descriptor() ([]byte, []int) {
	return file_multiplier_error_proto_rawDescGZIP(), []int{0}
}

var File_multiplier_error_proto protoreflect.FileDescriptor

var file_multiplier_error_proto_rawDesc = []byte{
	0x0a, 0x16, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x5f, 0x65, 0x72, 0x72,
...
var (
	file_multiplier_error_proto_rawDescOnce sync.Once
	file_multiplier_error_proto_rawDescData = file_multiplier_error_proto_rawDesc
)

func file_multiplier_error_proto_rawDescGZIP() []byte {
	file_multiplier_error_proto_rawDescOnce.Do(func() {
		file_multiplier_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_multiplier_error_proto_rawDescData)
	})
	return file_multiplier_error_proto_rawDescData
}

var file_multiplier_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_multiplier_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_multiplier_error_proto_goTypes = []interface{}{
...
var file_multiplier_error_proto_depIdxs = []int32{
...
func init() { file_multiplier_error_proto_init() }
func file_multiplier_error_proto_init() {
	if File_multiplier_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_multiplier_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_multiplier_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_multiplier_error_proto_goTypes,
		DependencyIndexes: file_multiplier_error_proto_depIdxs,
		EnumInfos:         file_multiplier_error_proto_enumTypes,
		MessageInfos:      file_multiplier_error_proto_msgTypes,
	}.Build()
	File_multiplier_error_proto = out.File
	file_multiplier_error_proto_rawDesc = nil
	file_multiplier_error_proto_goTypes = nil
	file_multiplier_error_proto_depIdxs = nil
}
