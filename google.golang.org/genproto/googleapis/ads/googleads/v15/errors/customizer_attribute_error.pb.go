...
// 	protoc        v5.26.1
// source: customizer_attribute_error.proto
...
func (CustomizerAttributeErrorEnum_CustomizerAttributeError) Descriptor() protoreflect.EnumDescriptor {
	return file_customizer_attribute_error_proto_enumTypes[0].Descriptor()
}

func (CustomizerAttributeErrorEnum_CustomizerAttributeError) Type() protoreflect.EnumType {
	return &file_customizer_attribute_error_proto_enumTypes[0]
}
...
func (CustomizerAttributeErrorEnum_CustomizerAttributeError) EnumDescriptor() ([]byte, []int) {
	return file_customizer_attribute_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CustomizerAttributeErrorEnum) Reset() {
	*x = CustomizerAttributeErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_customizer_attribute_error_proto_msgTypes[0]
...
func (*CustomizerAttributeErrorEnum) Descriptor() ([]byte, []int) {
	return file_customizer_attribute_error_proto_rawDescGZIP(), []int{0}
}

var File_customizer_attribute_error_proto protoreflect.FileDescriptor

var file_customizer_attribute_error_proto_rawDesc = []byte{
	0x0a, 0x20, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65, 0x72, 0x5f, 0x61, 0x74, 0x74,
...
var (
	file_customizer_attribute_error_proto_rawDescOnce sync.Once
	file_customizer_attribute_error_proto_rawDescData = file_customizer_attribute_error_proto_rawDesc
)

func file_customizer_attribute_error_proto_rawDescGZIP() []byte {
	file_customizer_attribute_error_proto_rawDescOnce.Do(func() {
		file_customizer_attribute_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_customizer_attribute_error_proto_rawDescData)
	})
	return file_customizer_attribute_error_proto_rawDescData
}

var file_customizer_attribute_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_customizer_attribute_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_customizer_attribute_error_proto_goTypes = []interface{}{
...
var file_customizer_attribute_error_proto_depIdxs = []int32{
...
func init() { file_customizer_attribute_error_proto_init() }
func file_customizer_attribute_error_proto_init() {
	if File_customizer_attribute_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_customizer_attribute_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_customizer_attribute_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_customizer_attribute_error_proto_goTypes,
		DependencyIndexes: file_customizer_attribute_error_proto_depIdxs,
		EnumInfos:         file_customizer_attribute_error_proto_enumTypes,
		MessageInfos:      file_customizer_attribute_error_proto_msgTypes,
	}.Build()
	File_customizer_attribute_error_proto = out.File
	file_customizer_attribute_error_proto_rawDesc = nil
	file_customizer_attribute_error_proto_goTypes = nil
	file_customizer_attribute_error_proto_depIdxs = nil
}
