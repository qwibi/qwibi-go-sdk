...
func (MutateErrorEnum_MutateError) Descriptor() protoreflect.EnumDescriptor {
	return file_mutate_error_proto_enumTypes[0].Descriptor()
}

func (MutateErrorEnum_MutateError) Type() protoreflect.EnumType {
	return &file_mutate_error_proto_enumTypes[0]
}
...
func (MutateErrorEnum_MutateError) EnumDescriptor() ([]byte, []int) {
	return file_mutate_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *MutateErrorEnum) Reset() {
	*x = MutateErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mutate_error_proto_msgTypes[0]
...
func (*MutateErrorEnum) Descriptor() ([]byte, []int) {
	return file_mutate_error_proto_rawDescGZIP(), []int{0}
}

var File_mutate_error_proto protoreflect.FileDescriptor

var file_mutate_error_proto_rawDesc = []byte{
	0x0a, 0x12, 0x6d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x70,
...
var (
	file_mutate_error_proto_rawDescOnce sync.Once
	file_mutate_error_proto_rawDescData = file_mutate_error_proto_rawDesc
)

func file_mutate_error_proto_rawDescGZIP() []byte {
	file_mutate_error_proto_rawDescOnce.Do(func() {
		file_mutate_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_mutate_error_proto_rawDescData)
	})
	return file_mutate_error_proto_rawDescData
}

var file_mutate_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_mutate_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mutate_error_proto_goTypes = []interface{}{
...
var file_mutate_error_proto_depIdxs = []int32{
...
func init() { file_mutate_error_proto_init() }
func file_mutate_error_proto_init() {
	if File_mutate_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mutate_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mutate_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mutate_error_proto_goTypes,
		DependencyIndexes: file_mutate_error_proto_depIdxs,
		EnumInfos:         file_mutate_error_proto_enumTypes,
		MessageInfos:      file_mutate_error_proto_msgTypes,
	}.Build()
	File_mutate_error_proto = out.File
	file_mutate_error_proto_rawDesc = nil
	file_mutate_error_proto_goTypes = nil
	file_mutate_error_proto_depIdxs = nil
}
