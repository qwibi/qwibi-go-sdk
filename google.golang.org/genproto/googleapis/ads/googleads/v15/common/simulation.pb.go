...
func file_simulation_proto_init() {
	...
	file_simulation_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*CpcBidSimulationPoint_CpcBidMicros)(nil),
		(*CpcBidSimulationPoint_CpcBidScalingModifier)(nil),
	}
	file_simulation_proto_msgTypes[8].OneofWrappers = []interface{}{}
	file_simulation_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*TargetCpaSimulationPoint_TargetCpaMicros)(nil),
		(*TargetCpaSimulationPoint_TargetCpaScalingModifier)(nil),
	}
	file_simulation_proto_msgTypes[10].OneofWrappers = []interface{}{}
	file_simulation_proto_msgTypes[11].OneofWrappers = []interface{}{}
	type x struct{}
