...
func (x *Money) Reset() {
	*x = Money{}
	if protoimpl.UnsafeEnabled {
		mi := &file_feed_common_proto_msgTypes[0]
...
func (*Money) Descriptor() ([]byte, []int) {
	return file_feed_common_proto_rawDescGZIP(), []int{0}
}
...
var File_feed_common_proto protoreflect.FileDescriptor

var file_feed_common_proto_rawDesc = []byte{
	0x0a, 0x11, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72,
...
var (
	file_feed_common_proto_rawDescOnce sync.Once
	file_feed_common_proto_rawDescData = file_feed_common_proto_rawDesc
)

func file_feed_common_proto_rawDescGZIP() []byte {
	file_feed_common_proto_rawDescOnce.Do(func() {
		file_feed_common_proto_rawDescData = protoimpl.X.CompressGZIP(file_feed_common_proto_rawDescData)
	})
	return file_feed_common_proto_rawDescData
}

var file_feed_common_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_feed_common_proto_goTypes = []interface{}{
	(*Money)(nil), // 0: google.ads.googleads.v15.common.Money
}
var file_feed_common_proto_depIdxs = []int32{
...
func init() { file_feed_common_proto_init() }
func file_feed_common_proto_init() {
	if File_feed_common_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_feed_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Money); i {
			case 0:
				return &v.state
			case 1:
	...
	file_feed_common_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_feed_common_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_feed_common_proto_goTypes,
		DependencyIndexes: file_feed_common_proto_depIdxs,
		MessageInfos:      file_feed_common_proto_msgTypes,
	}.Build()
	File_feed_common_proto = out.File
	file_feed_common_proto_rawDesc = nil
	file_feed_common_proto_goTypes = nil
	file_feed_common_proto_depIdxs = nil
}
