...
func (x *LocalServicesDocumentReadOnly) Reset() {
	*x = LocalServicesDocumentReadOnly{}
	if protoimpl.UnsafeEnabled {
		mi := &file_local_services_proto_msgTypes[0]
...
func (*LocalServicesDocumentReadOnly) Descriptor() ([]byte, []int) {
	return file_local_services_proto_rawDescGZIP(), []int{0}
}
...
var File_local_services_proto protoreflect.FileDescriptor

var file_local_services_proto_rawDesc = []byte{
	0x0a, 0x14, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
...
var (
	file_local_services_proto_rawDescOnce sync.Once
	file_local_services_proto_rawDescData = file_local_services_proto_rawDesc
)

func file_local_services_proto_rawDescGZIP() []byte {
	file_local_services_proto_rawDescOnce.Do(func() {
		file_local_services_proto_rawDescData = protoimpl.X.CompressGZIP(file_local_services_proto_rawDescData)
	})
	return file_local_services_proto_rawDescData
}

var file_local_services_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_local_services_proto_goTypes = []interface{}{
	(*LocalServicesDocumentReadOnly)(nil), // 0: google.ads.googleads.v15.common.LocalServicesDocumentReadOnly
}
var file_local_services_proto_depIdxs = []int32{
...
func init() { file_local_services_proto_init() }
func file_local_services_proto_init() {
	if File_local_services_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_local_services_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_local_services_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_local_services_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_local_services_proto_goTypes,
		DependencyIndexes: file_local_services_proto_depIdxs,
		MessageInfos:      file_local_services_proto_msgTypes,
	}.Build()
	File_local_services_proto = out.File
	file_local_services_proto_rawDesc = nil
	file_local_services_proto_goTypes = nil
	file_local_services_proto_depIdxs = nil
}
