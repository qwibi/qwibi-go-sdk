...
func (x *TextLabel) Reset() {
	*x = TextLabel{}
	if protoimpl.UnsafeEnabled {
		mi := &file_text_label_proto_msgTypes[0]
...
func (*TextLabel) Descriptor() ([]byte, []int) {
	return file_text_label_proto_rawDescGZIP(), []int{0}
}
...
var File_text_label_proto protoreflect.FileDescriptor

var file_text_label_proto_rawDesc = []byte{
	0x0a, 0x10, 0x74, 0x65, 0x78, 0x74, 0x5f, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f,
...
var (
	file_text_label_proto_rawDescOnce sync.Once
	file_text_label_proto_rawDescData = file_text_label_proto_rawDesc
)

func file_text_label_proto_rawDescGZIP() []byte {
	file_text_label_proto_rawDescOnce.Do(func() {
		file_text_label_proto_rawDescData = protoimpl.X.CompressGZIP(file_text_label_proto_rawDescData)
	})
	return file_text_label_proto_rawDescData
}

var file_text_label_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_text_label_proto_goTypes = []interface{}{
	(*TextLabel)(nil), // 0: google.ads.googleads.v15.common.TextLabel
}
var file_text_label_proto_depIdxs = []int32{
...
func init() { file_text_label_proto_init() }
func file_text_label_proto_init() {
	if File_text_label_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_text_label_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_text_label_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_text_label_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_text_label_proto_goTypes,
		DependencyIndexes: file_text_label_proto_depIdxs,
		MessageInfos:      file_text_label_proto_msgTypes,
	}.Build()
	File_text_label_proto = out.File
	file_text_label_proto_rawDesc = nil
	file_text_label_proto_goTypes = nil
	file_text_label_proto_depIdxs = nil
}
