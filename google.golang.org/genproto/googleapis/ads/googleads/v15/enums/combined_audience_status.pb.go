...
// 	protoc        v5.26.1
// source: combined_audience_status.proto
...
func (CombinedAudienceStatusEnum_CombinedAudienceStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_combined_audience_status_proto_enumTypes[0].Descriptor()
}

func (CombinedAudienceStatusEnum_CombinedAudienceStatus) Type() protoreflect.EnumType {
	return &file_combined_audience_status_proto_enumTypes[0]
}
...
func (CombinedAudienceStatusEnum_CombinedAudienceStatus) EnumDescriptor() ([]byte, []int) {
	return file_combined_audience_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CombinedAudienceStatusEnum) Reset() {
	*x = CombinedAudienceStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_combined_audience_status_proto_msgTypes[0]
...
func (*CombinedAudienceStatusEnum) Descriptor() ([]byte, []int) {
	return file_combined_audience_status_proto_rawDescGZIP(), []int{0}
}

var File_combined_audience_status_proto protoreflect.FileDescriptor

var file_combined_audience_status_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x64, 0x5f, 0x61, 0x75, 0x64, 0x69, 0x65,
	0x6e, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x22, 0x6e, 0x0a, 0x1a, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x64, 0x41, 0x75, 0x64, 0x69,
	0x65, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x50,
	0x0a, 0x16, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x64, 0x41, 0x75, 0x64, 0x69, 0x65, 0x6e,
	0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0f, 0x0a, 0x0b, 0x55, 0x4e, 0x53, 0x50,
	...
	0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1b, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65,
	0x64, 0x41, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x50,
...
var (
	file_combined_audience_status_proto_rawDescOnce sync.Once
	file_combined_audience_status_proto_rawDescData = file_combined_audience_status_proto_rawDesc
)

func file_combined_audience_status_proto_rawDescGZIP() []byte {
	file_combined_audience_status_proto_rawDescOnce.Do(func() {
		file_combined_audience_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_combined_audience_status_proto_rawDescData)
	})
	return file_combined_audience_status_proto_rawDescData
}

var file_combined_audience_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_combined_audience_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_combined_audience_status_proto_goTypes = []interface{}{
...
var file_combined_audience_status_proto_depIdxs = []int32{
...
func init() { file_combined_audience_status_proto_init() }
func file_combined_audience_status_proto_init() {
	if File_combined_audience_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_combined_audience_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_combined_audience_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_combined_audience_status_proto_goTypes,
		DependencyIndexes: file_combined_audience_status_proto_depIdxs,
		EnumInfos:         file_combined_audience_status_proto_enumTypes,
		MessageInfos:      file_combined_audience_status_proto_msgTypes,
	}.Build()
	File_combined_audience_status_proto = out.File
	file_combined_audience_status_proto_rawDesc = nil
	file_combined_audience_status_proto_goTypes = nil
	file_combined_audience_status_proto_depIdxs = nil
}
