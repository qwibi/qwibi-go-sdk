...
// 	protoc        v5.26.1
// source: budget_campaign_association_status.proto
...
func (BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_budget_campaign_association_status_proto_enumTypes[0].Descriptor()
}

func (BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus) Type() protoreflect.EnumType {
	return &file_budget_campaign_association_status_proto_enumTypes[0]
}
...
func (BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus) EnumDescriptor() ([]byte, []int) {
	return file_budget_campaign_association_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BudgetCampaignAssociationStatusEnum) Reset() {
	*x = BudgetCampaignAssociationStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_budget_campaign_association_status_proto_msgTypes[0]
...
func (*BudgetCampaignAssociationStatusEnum) Descriptor() ([]byte, []int) {
	return file_budget_campaign_association_status_proto_rawDescGZIP(), []int{0}
}

var File_budget_campaign_association_status_proto protoreflect.FileDescriptor

var file_budget_campaign_association_status_proto_rawDesc = []byte{
	0x0a, 0x28, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x5f, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67,
	...
	0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x80, 0x01, 0x0a, 0x23, 0x42,
	0x75, 0x64, 0x67, 0x65, 0x74, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x41, 0x73, 0x73,
	0x6f, 0x63, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e,
	0x75, 0x6d, 0x22, 0x59, 0x0a, 0x1f, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74, 0x43, 0x61, 0x6d, 0x70,
	...
	0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x4d, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x03, 0x42, 0xfe, 0x01,
	...
	0x6e, 0x75, 0x6d, 0x73, 0x42, 0x24, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74, 0x43, 0x61, 0x6d, 0x70,
	0x61, 0x69, 0x67, 0x6e, 0x41, 0x73, 0x73, 0x6f, 0x63, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53,
...
var (
	file_budget_campaign_association_status_proto_rawDescOnce sync.Once
	file_budget_campaign_association_status_proto_rawDescData = file_budget_campaign_association_status_proto_rawDesc
)

func file_budget_campaign_association_status_proto_rawDescGZIP() []byte {
	file_budget_campaign_association_status_proto_rawDescOnce.Do(func() {
		file_budget_campaign_association_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_budget_campaign_association_status_proto_rawDescData)
	})
	return file_budget_campaign_association_status_proto_rawDescData
}

var file_budget_campaign_association_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_budget_campaign_association_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_budget_campaign_association_status_proto_goTypes = []interface{}{
...
var file_budget_campaign_association_status_proto_depIdxs = []int32{
...
func init() { file_budget_campaign_association_status_proto_init() }
func file_budget_campaign_association_status_proto_init() {
	if File_budget_campaign_association_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_budget_campaign_association_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_budget_campaign_association_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_budget_campaign_association_status_proto_goTypes,
		DependencyIndexes: file_budget_campaign_association_status_proto_depIdxs,
		EnumInfos:         file_budget_campaign_association_status_proto_enumTypes,
		MessageInfos:      file_budget_campaign_association_status_proto_msgTypes,
	}.Build()
	File_budget_campaign_association_status_proto = out.File
	file_budget_campaign_association_status_proto_rawDesc = nil
	file_budget_campaign_association_status_proto_goTypes = nil
	file_budget_campaign_association_status_proto_depIdxs = nil
}
