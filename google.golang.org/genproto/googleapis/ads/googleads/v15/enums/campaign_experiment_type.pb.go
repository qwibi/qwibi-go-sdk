...
// 	protoc        v5.26.1
// source: campaign_experiment_type.proto
...
func (CampaignExperimentTypeEnum_CampaignExperimentType) Descriptor() protoreflect.EnumDescriptor {
	return file_campaign_experiment_type_proto_enumTypes[0].Descriptor()
}

func (CampaignExperimentTypeEnum_CampaignExperimentType) Type() protoreflect.EnumType {
	return &file_campaign_experiment_type_proto_enumTypes[0]
}
...
func (CampaignExperimentTypeEnum_CampaignExperimentType) EnumDescriptor() ([]byte, []int) {
	return file_campaign_experiment_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CampaignExperimentTypeEnum) Reset() {
	*x = CampaignExperimentTypeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_campaign_experiment_type_proto_msgTypes[0]
...
func (*CampaignExperimentTypeEnum) Descriptor() ([]byte, []int) {
	return file_campaign_experiment_type_proto_rawDescGZIP(), []int{0}
}

var File_campaign_experiment_type_proto protoreflect.FileDescriptor

var file_campaign_experiment_type_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x5f, 0x65, 0x78, 0x70, 0x65, 0x72,
	...
	0x22, 0x79, 0x0a, 0x1a, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x45, 0x78, 0x70, 0x65,
	0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x5b,
	0x0a, 0x16, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x45, 0x78, 0x70, 0x65, 0x72, 0x69,
	...
	0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x42, 0x41, 0x53, 0x45, 0x10, 0x02,
	0x12, 0x09, 0x0a, 0x05, 0x44, 0x52, 0x41, 0x46, 0x54, 0x10, 0x03, 0x12, 0x0e, 0x0a, 0x0a, 0x45,
	0x58, 0x50, 0x45, 0x52, 0x49, 0x4d, 0x45, 0x4e, 0x54, 0x10, 0x04, 0x42, 0xf5, 0x01, 0x0a, 0x22,
	...
	0x6d, 0x73, 0x42, 0x1b, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x45, 0x78, 0x70, 0x65,
	0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var (
	file_campaign_experiment_type_proto_rawDescOnce sync.Once
	file_campaign_experiment_type_proto_rawDescData = file_campaign_experiment_type_proto_rawDesc
)

func file_campaign_experiment_type_proto_rawDescGZIP() []byte {
	file_campaign_experiment_type_proto_rawDescOnce.Do(func() {
		file_campaign_experiment_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_campaign_experiment_type_proto_rawDescData)
	})
	return file_campaign_experiment_type_proto_rawDescData
}

var file_campaign_experiment_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_campaign_experiment_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_campaign_experiment_type_proto_goTypes = []interface{}{
...
var file_campaign_experiment_type_proto_depIdxs = []int32{
...
func init() { file_campaign_experiment_type_proto_init() }
func file_campaign_experiment_type_proto_init() {
	if File_campaign_experiment_type_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_campaign_experiment_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_campaign_experiment_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_campaign_experiment_type_proto_goTypes,
		DependencyIndexes: file_campaign_experiment_type_proto_depIdxs,
		EnumInfos:         file_campaign_experiment_type_proto_enumTypes,
		MessageInfos:      file_campaign_experiment_type_proto_msgTypes,
	}.Build()
	File_campaign_experiment_type_proto = out.File
	file_campaign_experiment_type_proto_rawDesc = nil
	file_campaign_experiment_type_proto_goTypes = nil
	file_campaign_experiment_type_proto_depIdxs = nil
}
