...
// 	protoc        v5.26.1
// source: seasonality_event_scope.proto
...
func (SeasonalityEventScopeEnum_SeasonalityEventScope) Descriptor() protoreflect.EnumDescriptor {
	return file_seasonality_event_scope_proto_enumTypes[0].Descriptor()
}

func (SeasonalityEventScopeEnum_SeasonalityEventScope) Type() protoreflect.EnumType {
	return &file_seasonality_event_scope_proto_enumTypes[0]
}
...
func (SeasonalityEventScopeEnum_SeasonalityEventScope) EnumDescriptor() ([]byte, []int) {
	return file_seasonality_event_scope_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SeasonalityEventScopeEnum) Reset() {
	*x = SeasonalityEventScopeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_seasonality_event_scope_proto_msgTypes[0]
...
func (*SeasonalityEventScopeEnum) Descriptor() ([]byte, []int) {
	return file_seasonality_event_scope_proto_rawDescGZIP(), []int{0}
}

var File_seasonality_event_scope_proto protoreflect.FileDescriptor

var file_seasonality_event_scope_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x73, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x5f, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x5f, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x7b, 0x0a, 0x19, 0x53, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x5e, 0x0a, 0x15,
	...
	0x02, 0x12, 0x0c, 0x0a, 0x08, 0x43, 0x41, 0x4d, 0x50, 0x41, 0x49, 0x47, 0x4e, 0x10, 0x04, 0x12,
	0x0b, 0x0a, 0x07, 0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45, 0x4c, 0x10, 0x05, 0x42, 0xf4, 0x01, 0x0a,
	...
	0x75, 0x6d, 0x73, 0x42, 0x1a, 0x53, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x69, 0x74, 0x79,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var (
	file_seasonality_event_scope_proto_rawDescOnce sync.Once
	file_seasonality_event_scope_proto_rawDescData = file_seasonality_event_scope_proto_rawDesc
)

func file_seasonality_event_scope_proto_rawDescGZIP() []byte {
	file_seasonality_event_scope_proto_rawDescOnce.Do(func() {
		file_seasonality_event_scope_proto_rawDescData = protoimpl.X.CompressGZIP(file_seasonality_event_scope_proto_rawDescData)
	})
	return file_seasonality_event_scope_proto_rawDescData
}

var file_seasonality_event_scope_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_seasonality_event_scope_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_seasonality_event_scope_proto_goTypes = []interface{}{
...
var file_seasonality_event_scope_proto_depIdxs = []int32{
...
func init() { file_seasonality_event_scope_proto_init() }
func file_seasonality_event_scope_proto_init() {
	if File_seasonality_event_scope_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_seasonality_event_scope_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_seasonality_event_scope_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_seasonality_event_scope_proto_goTypes,
		DependencyIndexes: file_seasonality_event_scope_proto_depIdxs,
		EnumInfos:         file_seasonality_event_scope_proto_enumTypes,
		MessageInfos:      file_seasonality_event_scope_proto_msgTypes,
	}.Build()
	File_seasonality_event_scope_proto = out.File
	file_seasonality_event_scope_proto_rawDesc = nil
	file_seasonality_event_scope_proto_goTypes = nil
	file_seasonality_event_scope_proto_depIdxs = nil
}
