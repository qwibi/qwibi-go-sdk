...
func (LabelStatusEnum_LabelStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_label_status_proto_enumTypes[0].Descriptor()
}

func (LabelStatusEnum_LabelStatus) Type() protoreflect.EnumType {
	return &file_label_status_proto_enumTypes[0]
}
...
func (LabelStatusEnum_LabelStatus) EnumDescriptor() ([]byte, []int) {
	return file_label_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *LabelStatusEnum) Reset() {
	*x = LabelStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_label_status_proto_msgTypes[0]
...
func (*LabelStatusEnum) Descriptor() ([]byte, []int) {
	return file_label_status_proto_rawDescGZIP(), []int{0}
}

var File_label_status_proto protoreflect.FileDescriptor

var file_label_status_proto_rawDesc = []byte{
	0x0a, 0x12, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x70,
	...
	0x6e, 0x75, 0x6d, 0x73, 0x22, 0x58, 0x0a, 0x0f, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x45, 0x0a, 0x0b, 0x4c, 0x61, 0x62, 0x65, 0x6c,
	...
	0x02, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x4d, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x03, 0x42, 0xea,
	...
	0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x10, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x53, 0x74, 0x61, 0x74,
...
var (
	file_label_status_proto_rawDescOnce sync.Once
	file_label_status_proto_rawDescData = file_label_status_proto_rawDesc
)

func file_label_status_proto_rawDescGZIP() []byte {
	file_label_status_proto_rawDescOnce.Do(func() {
		file_label_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_label_status_proto_rawDescData)
	})
	return file_label_status_proto_rawDescData
}

var file_label_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_label_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_label_status_proto_goTypes = []interface{}{
...
var file_label_status_proto_depIdxs = []int32{
...
func init() { file_label_status_proto_init() }
func file_label_status_proto_init() {
	if File_label_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_label_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_label_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_label_status_proto_goTypes,
		DependencyIndexes: file_label_status_proto_depIdxs,
		EnumInfos:         file_label_status_proto_enumTypes,
		MessageInfos:      file_label_status_proto_msgTypes,
	}.Build()
	File_label_status_proto = out.File
	file_label_status_proto_rawDesc = nil
	file_label_status_proto_goTypes = nil
	file_label_status_proto_depIdxs = nil
}
