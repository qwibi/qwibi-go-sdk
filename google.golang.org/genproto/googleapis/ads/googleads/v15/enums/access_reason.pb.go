...
func (AccessReasonEnum_AccessReason) Descriptor() protoreflect.EnumDescriptor {
	return file_access_reason_proto_enumTypes[0].Descriptor()
}

func (AccessReasonEnum_AccessReason) Type() protoreflect.EnumType {
	return &file_access_reason_proto_enumTypes[0]
}
...
func (AccessReasonEnum_AccessReason) EnumDescriptor() ([]byte, []int) {
	return file_access_reason_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AccessReasonEnum) Reset() {
	*x = AccessReasonEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_access_reason_proto_msgTypes[0]
...
func (*AccessReasonEnum) Descriptor() ([]byte, []int) {
	return file_access_reason_proto_rawDescGZIP(), []int{0}
}

var File_access_reason_proto protoreflect.FileDescriptor

var file_access_reason_proto_rawDesc = []byte{
	0x0a, 0x13, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x2e,
	...
	,
	...
	0x6e, 0x75, 0x6d, 0x73, 0x42, 0x11, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x61, 0x73,
...
var (
	file_access_reason_proto_rawDescOnce sync.Once
	file_access_reason_proto_rawDescData = file_access_reason_proto_rawDesc
)

func file_access_reason_proto_rawDescGZIP() []byte {
	file_access_reason_proto_rawDescOnce.Do(func() {
		file_access_reason_proto_rawDescData = protoimpl.X.CompressGZIP(file_access_reason_proto_rawDescData)
	})
	return file_access_reason_proto_rawDescData
}

var file_access_reason_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_access_reason_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_access_reason_proto_goTypes = []interface{}{
...
var file_access_reason_proto_depIdxs = []int32{
...
func init() { file_access_reason_proto_init() }
func file_access_reason_proto_init() {
	if File_access_reason_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_access_reason_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_access_reason_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_access_reason_proto_goTypes,
		DependencyIndexes: file_access_reason_proto_depIdxs,
		EnumInfos:         file_access_reason_proto_enumTypes,
		MessageInfos:      file_access_reason_proto_msgTypes,
	}.Build()
	File_access_reason_proto = out.File
	file_access_reason_proto_rawDesc = nil
	file_access_reason_proto_goTypes = nil
	file_access_reason_proto_depIdxs = nil
}
