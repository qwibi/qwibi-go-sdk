...
// 	protoc        v5.26.1
// source: conversion_action_status.proto
...
func (ConversionActionStatusEnum_ConversionActionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_conversion_action_status_proto_enumTypes[0].Descriptor()
}

func (ConversionActionStatusEnum_ConversionActionStatus) Type() protoreflect.EnumType {
	return &file_conversion_action_status_proto_enumTypes[0]
}
...
func (ConversionActionStatusEnum_ConversionActionStatus) EnumDescriptor() ([]byte, []int) {
	return file_conversion_action_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConversionActionStatusEnum) Reset() {
	*x = ConversionActionStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_conversion_action_status_proto_msgTypes[0]
...
func (*ConversionActionStatusEnum) Descriptor() ([]byte, []int) {
	return file_conversion_action_status_proto_rawDescGZIP(), []int{0}
}

var File_conversion_action_status_proto protoreflect.FileDescriptor

var file_conversion_action_status_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x61, 0x63, 0x74,
	...
	0x22, 0x7a, 0x0a, 0x1a, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x5c,
	0x0a, 0x16, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x41, 0x63, 0x74, 0x69,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x48, 0x49, 0x44, 0x44, 0x45, 0x4e, 0x10, 0x04, 0x42, 0xf5, 0x01, 0x0a,
	...
	0x75, 0x6d, 0x73, 0x42, 0x1b, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x41,
...
var (
	file_conversion_action_status_proto_rawDescOnce sync.Once
	file_conversion_action_status_proto_rawDescData = file_conversion_action_status_proto_rawDesc
)

func file_conversion_action_status_proto_rawDescGZIP() []byte {
	file_conversion_action_status_proto_rawDescOnce.Do(func() {
		file_conversion_action_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_conversion_action_status_proto_rawDescData)
	})
	return file_conversion_action_status_proto_rawDescData
}

var file_conversion_action_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_conversion_action_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_conversion_action_status_proto_goTypes = []interface{}{
...
var file_conversion_action_status_proto_depIdxs = []int32{
...
func init() { file_conversion_action_status_proto_init() }
func file_conversion_action_status_proto_init() {
	if File_conversion_action_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_conversion_action_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_conversion_action_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_conversion_action_status_proto_goTypes,
		DependencyIndexes: file_conversion_action_status_proto_depIdxs,
		EnumInfos:         file_conversion_action_status_proto_enumTypes,
		MessageInfos:      file_conversion_action_status_proto_msgTypes,
	}.Build()
	File_conversion_action_status_proto = out.File
	file_conversion_action_status_proto_rawDesc = nil
	file_conversion_action_status_proto_goTypes = nil
	file_conversion_action_status_proto_depIdxs = nil
}
