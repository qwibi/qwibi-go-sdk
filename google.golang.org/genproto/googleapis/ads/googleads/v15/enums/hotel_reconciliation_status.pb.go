...
// 	protoc        v5.26.1
// source: hotel_reconciliation_status.proto
...
func (HotelReconciliationStatusEnum_HotelReconciliationStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_hotel_reconciliation_status_proto_enumTypes[0].Descriptor()
}

func (HotelReconciliationStatusEnum_HotelReconciliationStatus) Type() protoreflect.EnumType {
	return &file_hotel_reconciliation_status_proto_enumTypes[0]
}
...
func (HotelReconciliationStatusEnum_HotelReconciliationStatus) EnumDescriptor() ([]byte, []int) {
	return file_hotel_reconciliation_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *HotelReconciliationStatusEnum) Reset() {
	*x = HotelReconciliationStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_hotel_reconciliation_status_proto_msgTypes[0]
...
func (*HotelReconciliationStatusEnum) Descriptor() ([]byte, []int) {
	return file_hotel_reconciliation_status_proto_rawDescGZIP(), []int{0}
}

var File_hotel_reconciliation_status_proto protoreflect.FileDescriptor

var file_hotel_reconciliation_status_proto_rawDesc = []byte{
	0x0a, 0x21, 0x68, 0x6f, 0x74, 0x65, 0x6c, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x6e, 0x63, 0x69, 0x6c,
	0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x70, 0x72,
	...
	0x75, 0x6d, 0x73, 0x22, 0xad, 0x01, 0x0a, 0x1d, 0x48, 0x6f, 0x74, 0x65, 0x6c, 0x52, 0x65, 0x63,
	0x6f, 0x6e, 0x63, 0x69, 0x6c, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x8b, 0x01, 0x0a, 0x19, 0x48, 0x6f, 0x74, 0x65, 0x6c, 0x52,
	...
	,
...
var (
	file_hotel_reconciliation_status_proto_rawDescOnce sync.Once
	file_hotel_reconciliation_status_proto_rawDescData = file_hotel_reconciliation_status_proto_rawDesc
)

func file_hotel_reconciliation_status_proto_rawDescGZIP() []byte {
	file_hotel_reconciliation_status_proto_rawDescOnce.Do(func() {
		file_hotel_reconciliation_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_hotel_reconciliation_status_proto_rawDescData)
	})
	return file_hotel_reconciliation_status_proto_rawDescData
}

var file_hotel_reconciliation_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_hotel_reconciliation_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_hotel_reconciliation_status_proto_goTypes = []interface{}{
...
var file_hotel_reconciliation_status_proto_depIdxs = []int32{
...
func init() { file_hotel_reconciliation_status_proto_init() }
func file_hotel_reconciliation_status_proto_init() {
	if File_hotel_reconciliation_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_hotel_reconciliation_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_hotel_reconciliation_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_hotel_reconciliation_status_proto_goTypes,
		DependencyIndexes: file_hotel_reconciliation_status_proto_depIdxs,
		EnumInfos:         file_hotel_reconciliation_status_proto_enumTypes,
		MessageInfos:      file_hotel_reconciliation_status_proto_msgTypes,
	}.Build()
	File_hotel_reconciliation_status_proto = out.File
	file_hotel_reconciliation_status_proto_rawDesc = nil
	file_hotel_reconciliation_status_proto_goTypes = nil
	file_hotel_reconciliation_status_proto_depIdxs = nil
}
