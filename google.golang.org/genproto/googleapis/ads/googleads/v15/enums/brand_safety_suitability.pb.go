...
// 	protoc        v5.26.1
// source: brand_safety_suitability.proto
...
func (BrandSafetySuitabilityEnum_BrandSafetySuitability) Descriptor() protoreflect.EnumDescriptor {
	return file_brand_safety_suitability_proto_enumTypes[0].Descriptor()
}

func (BrandSafetySuitabilityEnum_BrandSafetySuitability) Type() protoreflect.EnumType {
	return &file_brand_safety_suitability_proto_enumTypes[0]
}
...
func (BrandSafetySuitabilityEnum_BrandSafetySuitability) EnumDescriptor() ([]byte, []int) {
	return file_brand_safety_suitability_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BrandSafetySuitabilityEnum) Reset() {
	*x = BrandSafetySuitabilityEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_brand_safety_suitability_proto_msgTypes[0]
...
func (*BrandSafetySuitabilityEnum) Descriptor() ([]byte, []int) {
	return file_brand_safety_suitability_proto_rawDescGZIP(), []int{0}
}

var File_brand_safety_suitability_proto protoreflect.FileDescriptor

var file_brand_safety_suitability_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x5f, 0x73, 0x61, 0x66, 0x65, 0x74, 0x79, 0x5f, 0x73,
	0x75, 0x69, 0x74, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	,
	...
	0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1b, 0x42, 0x72, 0x61, 0x6e, 0x64, 0x53, 0x61, 0x66, 0x65,
	0x74, 0x79, 0x53, 0x75, 0x69, 0x74, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x50, 0x72, 0x6f,
...
var (
	file_brand_safety_suitability_proto_rawDescOnce sync.Once
	file_brand_safety_suitability_proto_rawDescData = file_brand_safety_suitability_proto_rawDesc
)

func file_brand_safety_suitability_proto_rawDescGZIP() []byte {
	file_brand_safety_suitability_proto_rawDescOnce.Do(func() {
		file_brand_safety_suitability_proto_rawDescData = protoimpl.X.CompressGZIP(file_brand_safety_suitability_proto_rawDescData)
	})
	return file_brand_safety_suitability_proto_rawDescData
}

var file_brand_safety_suitability_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_brand_safety_suitability_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_brand_safety_suitability_proto_goTypes = []interface{}{
...
var file_brand_safety_suitability_proto_depIdxs = []int32{
...
func init() { file_brand_safety_suitability_proto_init() }
func file_brand_safety_suitability_proto_init() {
	if File_brand_safety_suitability_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_brand_safety_suitability_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_brand_safety_suitability_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_brand_safety_suitability_proto_goTypes,
		DependencyIndexes: file_brand_safety_suitability_proto_depIdxs,
		EnumInfos:         file_brand_safety_suitability_proto_enumTypes,
		MessageInfos:      file_brand_safety_suitability_proto_msgTypes,
	}.Build()
	File_brand_safety_suitability_proto = out.File
	file_brand_safety_suitability_proto_rawDesc = nil
	file_brand_safety_suitability_proto_goTypes = nil
	file_brand_safety_suitability_proto_depIdxs = nil
}
