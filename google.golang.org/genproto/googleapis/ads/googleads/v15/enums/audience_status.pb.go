...
func (AudienceStatusEnum_AudienceStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_audience_status_proto_enumTypes[0].Descriptor()
}

func (AudienceStatusEnum_AudienceStatus) Type() protoreflect.EnumType {
	return &file_audience_status_proto_enumTypes[0]
}
...
func (AudienceStatusEnum_AudienceStatus) EnumDescriptor() ([]byte, []int) {
	return file_audience_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AudienceStatusEnum) Reset() {
	*x = AudienceStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_audience_status_proto_msgTypes[0]
...
func (*AudienceStatusEnum) Descriptor() ([]byte, []int) {
	return file_audience_status_proto_rawDescGZIP(), []int{0}
}

var File_audience_status_proto protoreflect.FileDescriptor

var file_audience_status_proto_rawDesc = []byte{
	0x0a, 0x15, 0x61, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x5e, 0x0a, 0x12, 0x41, 0x75, 0x64, 0x69, 0x65,
	0x6e, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x48, 0x0a,
	0x0e, 0x41, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
...
var (
	file_audience_status_proto_rawDescOnce sync.Once
	file_audience_status_proto_rawDescData = file_audience_status_proto_rawDesc
)

func file_audience_status_proto_rawDescGZIP() []byte {
	file_audience_status_proto_rawDescOnce.Do(func() {
		file_audience_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_audience_status_proto_rawDescData)
	})
	return file_audience_status_proto_rawDescData
}

var file_audience_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_audience_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_audience_status_proto_goTypes = []interface{}{
...
var file_audience_status_proto_depIdxs = []int32{
...
func init() { file_audience_status_proto_init() }
func file_audience_status_proto_init() {
	if File_audience_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_audience_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_audience_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_audience_status_proto_goTypes,
		DependencyIndexes: file_audience_status_proto_depIdxs,
		EnumInfos:         file_audience_status_proto_enumTypes,
		MessageInfos:      file_audience_status_proto_msgTypes,
	}.Build()
	File_audience_status_proto = out.File
	file_audience_status_proto_rawDesc = nil
	file_audience_status_proto_goTypes = nil
	file_audience_status_proto_depIdxs = nil
}
