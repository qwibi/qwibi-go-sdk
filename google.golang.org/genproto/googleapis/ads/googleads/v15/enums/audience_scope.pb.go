...
func (AudienceScopeEnum_AudienceScope) Descriptor() protoreflect.EnumDescriptor {
	return file_audience_scope_proto_enumTypes[0].Descriptor()
}

func (AudienceScopeEnum_AudienceScope) Type() protoreflect.EnumType {
	return &file_audience_scope_proto_enumTypes[0]
}
...
func (AudienceScopeEnum_AudienceScope) EnumDescriptor() ([]byte, []int) {
	return file_audience_scope_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AudienceScopeEnum) Reset() {
	*x = AudienceScopeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_audience_scope_proto_msgTypes[0]
...
func (*AudienceScopeEnum) Descriptor() ([]byte, []int) {
	return file_audience_scope_proto_rawDescGZIP(), []int{0}
}

var File_audience_scope_proto protoreflect.FileDescriptor

var file_audience_scope_proto_rawDesc = []byte{
	0x0a, 0x14, 0x61, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x73, 0x63, 0x6f, 0x70, 0x65,
	...
	0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x61, 0x0a, 0x11, 0x41, 0x75, 0x64, 0x69, 0x65, 0x6e,
	0x63, 0x65, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x4c, 0x0a, 0x0d, 0x41,
	0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x12, 0x0f, 0x0a, 0x0b,
	0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0b, 0x0a,
	0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x43, 0x55,
	0x53, 0x54, 0x4f, 0x4d, 0x45, 0x52, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x41, 0x53, 0x53, 0x45,
	0x54, 0x5f, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x10, 0x03, 0x42, 0xec, 0x01, 0x0a, 0x22, 0x63, 0x6f,
	...
	0x42, 0x12, 0x41, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x50,
...
var (
	file_audience_scope_proto_rawDescOnce sync.Once
	file_audience_scope_proto_rawDescData = file_audience_scope_proto_rawDesc
)

func file_audience_scope_proto_rawDescGZIP() []byte {
	file_audience_scope_proto_rawDescOnce.Do(func() {
		file_audience_scope_proto_rawDescData = protoimpl.X.CompressGZIP(file_audience_scope_proto_rawDescData)
	})
	return file_audience_scope_proto_rawDescData
}

var file_audience_scope_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_audience_scope_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_audience_scope_proto_goTypes = []interface{}{
...
var file_audience_scope_proto_depIdxs = []int32{
...
func init() { file_audience_scope_proto_init() }
func file_audience_scope_proto_init() {
	if File_audience_scope_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_audience_scope_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_audience_scope_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_audience_scope_proto_goTypes,
		DependencyIndexes: file_audience_scope_proto_depIdxs,
		EnumInfos:         file_audience_scope_proto_enumTypes,
		MessageInfos:      file_audience_scope_proto_msgTypes,
	}.Build()
	File_audience_scope_proto = out.File
	file_audience_scope_proto_rawDesc = nil
	file_audience_scope_proto_goTypes = nil
	file_audience_scope_proto_depIdxs = nil
}
