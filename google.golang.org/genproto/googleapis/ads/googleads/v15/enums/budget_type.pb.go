...
func (BudgetTypeEnum_BudgetType) Descriptor() protoreflect.EnumDescriptor {
	return file_budget_type_proto_enumTypes[0].Descriptor()
}

func (BudgetTypeEnum_BudgetType) Type() protoreflect.EnumType {
	return &file_budget_type_proto_enumTypes[0]
}
...
func (BudgetTypeEnum_BudgetType) EnumDescriptor() ([]byte, []int) {
	return file_budget_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BudgetTypeEnum) Reset() {
	*x = BudgetTypeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_budget_type_proto_msgTypes[0]
...
func (*BudgetTypeEnum) Descriptor() ([]byte, []int) {
	return file_budget_type_proto_rawDescGZIP(), []int{0}
}

var File_budget_type_proto protoreflect.FileDescriptor

var file_budget_type_proto_rawDesc = []byte{
	0x0a, 0x11, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72,
	...
	0x75, 0x6d, 0x73, 0x22, 0x81, 0x01, 0x0a, 0x0e, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x6f, 0x0a, 0x0a, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74,
	...
	0x12, 0x0d, 0x0a, 0x09, 0x46, 0x49, 0x58, 0x45, 0x44, 0x5f, 0x43, 0x50, 0x41, 0x10, 0x04, 0x12,
	0x12, 0x0a, 0x0e, 0x53, 0x4d, 0x41, 0x52, 0x54, 0x5f, 0x43, 0x41, 0x4d, 0x50, 0x41, 0x49, 0x47,
	0x4e, 0x10, 0x05, 0x12, 0x12, 0x0a, 0x0e, 0x4c, 0x4f, 0x43, 0x41, 0x4c, 0x5f, 0x53, 0x45, 0x52,
	0x56, 0x49, 0x43, 0x45, 0x53, 0x10, 0x06, 0x42, 0xe9, 0x01, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e,
...
var (
	file_budget_type_proto_rawDescOnce sync.Once
	file_budget_type_proto_rawDescData = file_budget_type_proto_rawDesc
)

func file_budget_type_proto_rawDescGZIP() []byte {
	file_budget_type_proto_rawDescOnce.Do(func() {
		file_budget_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_budget_type_proto_rawDescData)
	})
	return file_budget_type_proto_rawDescData
}

var file_budget_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_budget_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_budget_type_proto_goTypes = []interface{}{
...
var file_budget_type_proto_depIdxs = []int32{
...
func init() { file_budget_type_proto_init() }
func file_budget_type_proto_init() {
	if File_budget_type_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_budget_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_budget_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_budget_type_proto_goTypes,
		DependencyIndexes: file_budget_type_proto_depIdxs,
		EnumInfos:         file_budget_type_proto_enumTypes,
		MessageInfos:      file_budget_type_proto_msgTypes,
	}.Build()
	File_budget_type_proto = out.File
	file_budget_type_proto_rawDesc = nil
	file_budget_type_proto_goTypes = nil
	file_budget_type_proto_depIdxs = nil
}
