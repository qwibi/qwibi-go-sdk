...
// 	protoc        v5.26.1
// source: user_list_access_status.proto
...
func (UserListAccessStatusEnum_UserListAccessStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_user_list_access_status_proto_enumTypes[0].Descriptor()
}

func (UserListAccessStatusEnum_UserListAccessStatus) Type() protoreflect.EnumType {
	return &file_user_list_access_status_proto_enumTypes[0]
}
...
func (UserListAccessStatusEnum_UserListAccessStatus) EnumDescriptor() ([]byte, []int) {
	return file_user_list_access_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *UserListAccessStatusEnum) Reset() {
	*x = UserListAccessStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_user_list_access_status_proto_msgTypes[0]
...
func (*UserListAccessStatusEnum) Descriptor() ([]byte, []int) {
	return file_user_list_access_status_proto_rawDescGZIP(), []int{0}
}

var File_user_list_access_status_proto protoreflect.FileDescriptor

var file_user_list_access_status_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x61, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x6b, 0x0a, 0x18, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x4f, 0x0a, 0x14, 0x55,
	...
	0x0a, 0x08, 0x44, 0x49, 0x53, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x42, 0xf3, 0x01, 0x0a,
	...
	0x75, 0x6d, 0x73, 0x42, 0x19, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var (
	file_user_list_access_status_proto_rawDescOnce sync.Once
	file_user_list_access_status_proto_rawDescData = file_user_list_access_status_proto_rawDesc
)

func file_user_list_access_status_proto_rawDescGZIP() []byte {
	file_user_list_access_status_proto_rawDescOnce.Do(func() {
		file_user_list_access_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_user_list_access_status_proto_rawDescData)
	})
	return file_user_list_access_status_proto_rawDescData
}

var file_user_list_access_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_user_list_access_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_user_list_access_status_proto_goTypes = []interface{}{
...
var file_user_list_access_status_proto_depIdxs = []int32{
...
func init() { file_user_list_access_status_proto_init() }
func file_user_list_access_status_proto_init() {
	if File_user_list_access_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_user_list_access_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_user_list_access_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_user_list_access_status_proto_goTypes,
		DependencyIndexes: file_user_list_access_status_proto_depIdxs,
		EnumInfos:         file_user_list_access_status_proto_enumTypes,
		MessageInfos:      file_user_list_access_status_proto_msgTypes,
	}.Build()
	File_user_list_access_status_proto = out.File
	file_user_list_access_status_proto_rawDesc = nil
	file_user_list_access_status_proto_goTypes = nil
	file_user_list_access_status_proto_depIdxs = nil
}
