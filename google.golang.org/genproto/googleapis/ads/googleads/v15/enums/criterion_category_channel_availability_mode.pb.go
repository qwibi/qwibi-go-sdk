...
// 	protoc        v5.26.1
// source: criterion_category_channel_availability_mode.proto
...
func (CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode) Descriptor() protoreflect.EnumDescriptor {
	return file_criterion_category_channel_availability_mode_proto_enumTypes[0].Descriptor()
}

func (CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode) Type() protoreflect.EnumType {
	return &file_criterion_category_channel_availability_mode_proto_enumTypes[0]
}
...
func (CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode) EnumDescriptor() ([]byte, []int) {
	return file_criterion_category_channel_availability_mode_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CriterionCategoryChannelAvailabilityModeEnum) Reset() {
	*x = CriterionCategoryChannelAvailabilityModeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_criterion_category_channel_availability_mode_proto_msgTypes[0]
...
func (*CriterionCategoryChannelAvailabilityModeEnum) Descriptor() ([]byte, []int) {
	return file_criterion_category_channel_availability_mode_proto_rawDescGZIP(), []int{0}
}

var File_criterion_category_channel_availability_mode_proto protoreflect.FileDescriptor

var file_criterion_category_channel_availability_mode_proto_rawDesc = []byte{
	0x0a, 0x32, 0x63, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x61, 0x76, 0x61,
	0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x2e, 0x70,
	...
	0x6e, 0x75, 0x6d, 0x73, 0x22, 0xd4, 0x01, 0x0a, 0x2c, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69,
	...
	0x65, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0xa3, 0x01, 0x0a, 0x28, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72,
	0x69, 0x6f, 0x6e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x43, 0x68, 0x61, 0x6e, 0x6e,
	0x65, 0x6c, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x4d, 0x6f,
	...
	0x12, 0x10, 0x0a, 0x0c, 0x41, 0x4c, 0x4c, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45, 0x4c, 0x53,
	0x10, 0x02, 0x12, 0x21, 0x0a, 0x1d, 0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45, 0x4c, 0x5f, 0x54, 0x59,
	0x50, 0x45, 0x5f, 0x41, 0x4e, 0x44, 0x5f, 0x41, 0x4c, 0x4c, 0x5f, 0x53, 0x55, 0x42, 0x54, 0x59,
	0x50, 0x45, 0x53, 0x10, 0x03, 0x12, 0x24, 0x0a, 0x20, 0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45, 0x4c,
	0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x41, 0x4e, 0x44, 0x5f, 0x53, 0x55, 0x42, 0x53, 0x45, 0x54,
	0x5f, 0x53, 0x55, 0x42, 0x54, 0x59, 0x50, 0x45, 0x53, 0x10, 0x04, 0x42, 0x87, 0x02, 0x0a, 0x22,
	...
	0x6d, 0x73, 0x42, 0x2d, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x6f, 0x6e, 0x43, 0x61, 0x74,
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x41, 0x76, 0x61, 0x69,
	0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x4d, 0x6f, 0x64, 0x65, 0x50, 0x72, 0x6f, 0x74,
...
var (
	file_criterion_category_channel_availability_mode_proto_rawDescOnce sync.Once
	file_criterion_category_channel_availability_mode_proto_rawDescData = file_criterion_category_channel_availability_mode_proto_rawDesc
)

func file_criterion_category_channel_availability_mode_proto_rawDescGZIP() []byte {
	file_criterion_category_channel_availability_mode_proto_rawDescOnce.Do(func() {
		file_criterion_category_channel_availability_mode_proto_rawDescData = protoimpl.X.CompressGZIP(file_criterion_category_channel_availability_mode_proto_rawDescData)
	})
	return file_criterion_category_channel_availability_mode_proto_rawDescData
}

var file_criterion_category_channel_availability_mode_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_criterion_category_channel_availability_mode_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_criterion_category_channel_availability_mode_proto_goTypes = []interface{}{
...
var file_criterion_category_channel_availability_mode_proto_depIdxs = []int32{
...
func init() { file_criterion_category_channel_availability_mode_proto_init() }
func file_criterion_category_channel_availability_mode_proto_init() {
	if File_criterion_category_channel_availability_mode_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_criterion_category_channel_availability_mode_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_criterion_category_channel_availability_mode_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_criterion_category_channel_availability_mode_proto_goTypes,
		DependencyIndexes: file_criterion_category_channel_availability_mode_proto_depIdxs,
		EnumInfos:         file_criterion_category_channel_availability_mode_proto_enumTypes,
		MessageInfos:      file_criterion_category_channel_availability_mode_proto_msgTypes,
	}.Build()
	File_criterion_category_channel_availability_mode_proto = out.File
	file_criterion_category_channel_availability_mode_proto_rawDesc = nil
	file_criterion_category_channel_availability_mode_proto_goTypes = nil
	file_criterion_category_channel_availability_mode_proto_depIdxs = nil
}
