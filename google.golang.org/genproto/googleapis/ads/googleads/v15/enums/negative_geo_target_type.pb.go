...
// 	protoc        v5.26.1
// source: negative_geo_target_type.proto
...
func (NegativeGeoTargetTypeEnum_NegativeGeoTargetType) Descriptor() protoreflect.EnumDescriptor {
	return file_negative_geo_target_type_proto_enumTypes[0].Descriptor()
}

func (NegativeGeoTargetTypeEnum_NegativeGeoTargetType) Type() protoreflect.EnumType {
	return &file_negative_geo_target_type_proto_enumTypes[0]
}
...
func (NegativeGeoTargetTypeEnum_NegativeGeoTargetType) EnumDescriptor() ([]byte, []int) {
	return file_negative_geo_target_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *NegativeGeoTargetTypeEnum) Reset() {
	*x = NegativeGeoTargetTypeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_negative_geo_target_type_proto_msgTypes[0]
...
func (*NegativeGeoTargetTypeEnum) Descriptor() ([]byte, []int) {
	return file_negative_geo_target_type_proto_rawDescGZIP(), []int{0}
}

var File_negative_geo_target_type_proto protoreflect.FileDescriptor

var file_negative_geo_target_type_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x6e, 0x65, 0x67, 0x61, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x67, 0x65, 0x6f, 0x5f, 0x74,
	...
	0x22, 0x7a, 0x0a, 0x19, 0x4e, 0x65, 0x67, 0x61, 0x74, 0x69, 0x76, 0x65, 0x47, 0x65, 0x6f, 0x54,
	0x61, 0x72, 0x67, 0x65, 0x74, 0x54, 0x79, 0x70, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x5d, 0x0a,
	0x15, 0x4e, 0x65, 0x67, 0x61, 0x74, 0x69, 0x76, 0x65, 0x47, 0x65, 0x6f, 0x54, 0x61, 0x72, 0x67,
	...
	0x5f, 0x4f, 0x52, 0x5f, 0x49, 0x4e, 0x54, 0x45, 0x52, 0x45, 0x53, 0x54, 0x10, 0x04, 0x12, 0x0c,
	0x0a, 0x08, 0x50, 0x52, 0x45, 0x53, 0x45, 0x4e, 0x43, 0x45, 0x10, 0x05, 0x42, 0xf4, 0x01, 0x0a,
	...
	0x75, 0x6d, 0x73, 0x42, 0x1a, 0x4e, 0x65, 0x67, 0x61, 0x74, 0x69, 0x76, 0x65, 0x47, 0x65, 0x6f,
...
var (
	file_negative_geo_target_type_proto_rawDescOnce sync.Once
	file_negative_geo_target_type_proto_rawDescData = file_negative_geo_target_type_proto_rawDesc
)

func file_negative_geo_target_type_proto_rawDescGZIP() []byte {
	file_negative_geo_target_type_proto_rawDescOnce.Do(func() {
		file_negative_geo_target_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_negative_geo_target_type_proto_rawDescData)
	})
	return file_negative_geo_target_type_proto_rawDescData
}

var file_negative_geo_target_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_negative_geo_target_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_negative_geo_target_type_proto_goTypes = []interface{}{
...
var file_negative_geo_target_type_proto_depIdxs = []int32{
...
func init() { file_negative_geo_target_type_proto_init() }
func file_negative_geo_target_type_proto_init() {
	if File_negative_geo_target_type_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_negative_geo_target_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_negative_geo_target_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_negative_geo_target_type_proto_goTypes,
		DependencyIndexes: file_negative_geo_target_type_proto_depIdxs,
		EnumInfos:         file_negative_geo_target_type_proto_enumTypes,
		MessageInfos:      file_negative_geo_target_type_proto_msgTypes,
	}.Build()
	File_negative_geo_target_type_proto = out.File
	file_negative_geo_target_type_proto_rawDesc = nil
	file_negative_geo_target_type_proto_goTypes = nil
	file_negative_geo_target_type_proto_depIdxs = nil
}
