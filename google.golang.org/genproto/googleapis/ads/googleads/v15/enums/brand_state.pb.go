...
func (BrandStateEnum_BrandState) Descriptor() protoreflect.EnumDescriptor {
	return file_brand_state_proto_enumTypes[0].Descriptor()
}

func (BrandStateEnum_BrandState) Type() protoreflect.EnumType {
	return &file_brand_state_proto_enumTypes[0]
}
...
func (BrandStateEnum_BrandState) EnumDescriptor() ([]byte, []int) {
	return file_brand_state_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BrandStateEnum) Reset() {
	*x = BrandStateEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_brand_state_proto_msgTypes[0]
...
func (*BrandStateEnum) Descriptor() ([]byte, []int) {
	return file_brand_state_proto_rawDescGZIP(), []int{0}
}

var File_brand_state_proto protoreflect.FileDescriptor

var file_brand_state_proto_rawDesc = []byte{
	0x0a, 0x11, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72,
	...
	0x75, 0x6d, 0x73, 0x22, 0x95, 0x01, 0x0a, 0x0e, 0x42, 0x72, 0x61, 0x6e, 0x64, 0x53, 0x74, 0x61,
	0x74, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x82, 0x01, 0x0a, 0x0a, 0x42, 0x72, 0x61, 0x6e, 0x64,
	...
	0x12, 0x0e, 0x0a, 0x0a, 0x55, 0x4e, 0x56, 0x45, 0x52, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x04,
	0x12, 0x0c, 0x0a, 0x08, 0x41, 0x50, 0x50, 0x52, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x05, 0x12, 0x0d,
	0x0a, 0x09, 0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c, 0x4c, 0x45, 0x44, 0x10, 0x06, 0x12, 0x0c, 0x0a,
	0x08, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x07, 0x42, 0xe9, 0x01, 0x0a, 0x22,
	...
	0x6d, 0x73, 0x42, 0x0f, 0x42, 0x72, 0x61, 0x6e, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x50, 0x72,
...
var (
	file_brand_state_proto_rawDescOnce sync.Once
	file_brand_state_proto_rawDescData = file_brand_state_proto_rawDesc
)

func file_brand_state_proto_rawDescGZIP() []byte {
	file_brand_state_proto_rawDescOnce.Do(func() {
		file_brand_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_brand_state_proto_rawDescData)
	})
	return file_brand_state_proto_rawDescData
}

var file_brand_state_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_brand_state_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_brand_state_proto_goTypes = []interface{}{
...
var file_brand_state_proto_depIdxs = []int32{
...
func init() { file_brand_state_proto_init() }
func file_brand_state_proto_init() {
	if File_brand_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_brand_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_brand_state_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_brand_state_proto_goTypes,
		DependencyIndexes: file_brand_state_proto_depIdxs,
		EnumInfos:         file_brand_state_proto_enumTypes,
		MessageInfos:      file_brand_state_proto_msgTypes,
	}.Build()
	File_brand_state_proto = out.File
	file_brand_state_proto_rawDesc = nil
	file_brand_state_proto_goTypes = nil
	file_brand_state_proto_depIdxs = nil
}
