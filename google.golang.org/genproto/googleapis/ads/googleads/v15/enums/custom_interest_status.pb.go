...
// 	protoc        v5.26.1
// source: custom_interest_status.proto
...
func (CustomInterestStatusEnum_CustomInterestStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_custom_interest_status_proto_enumTypes[0].Descriptor()
}

func (CustomInterestStatusEnum_CustomInterestStatus) Type() protoreflect.EnumType {
	return &file_custom_interest_status_proto_enumTypes[0]
}
...
func (CustomInterestStatusEnum_CustomInterestStatus) EnumDescriptor() ([]byte, []int) {
	return file_custom_interest_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CustomInterestStatusEnum) Reset() {
	*x = CustomInterestStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_custom_interest_status_proto_msgTypes[0]
...
func (*CustomInterestStatusEnum) Descriptor() ([]byte, []int) {
	return file_custom_interest_status_proto_rawDescGZIP(), []int{0}
}

var File_custom_interest_status_proto protoreflect.FileDescriptor

var file_custom_interest_status_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73,
	...
	0x73, 0x74, 0x6f, 0x6d, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74,
	...
	0x73, 0x42, 0x19, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73,
...
var (
	file_custom_interest_status_proto_rawDescOnce sync.Once
	file_custom_interest_status_proto_rawDescData = file_custom_interest_status_proto_rawDesc
)

func file_custom_interest_status_proto_rawDescGZIP() []byte {
	file_custom_interest_status_proto_rawDescOnce.Do(func() {
		file_custom_interest_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_custom_interest_status_proto_rawDescData)
	})
	return file_custom_interest_status_proto_rawDescData
}

var file_custom_interest_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_custom_interest_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_custom_interest_status_proto_goTypes = []interface{}{
...
var file_custom_interest_status_proto_depIdxs = []int32{
...
func init() { file_custom_interest_status_proto_init() }
func file_custom_interest_status_proto_init() {
	if File_custom_interest_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_custom_interest_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_custom_interest_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_custom_interest_status_proto_goTypes,
		DependencyIndexes: file_custom_interest_status_proto_depIdxs,
		EnumInfos:         file_custom_interest_status_proto_enumTypes,
		MessageInfos:      file_custom_interest_status_proto_msgTypes,
	}.Build()
	File_custom_interest_status_proto = out.File
	file_custom_interest_status_proto_rawDesc = nil
	file_custom_interest_status_proto_goTypes = nil
	file_custom_interest_status_proto_depIdxs = nil
}
