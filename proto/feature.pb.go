...
type QPBxFeature struct {
	...
	Geometry   *QPBxGeometry `protobuf:"bytes,1,opt,name=geometry,proto3" json:"geometry,omitempty"`
...
func (x *QPBxFeature) GetProperties() []byte {
	if x != nil {
		return x.Properties
	}
	return nil
...
var file_feature_proto_rawDesc = []byte{
	...
	0x58, 0x0a, 0x0b, 0x51, 0x50, 0x42, 0x78, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x29,
	...
	0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x70,
...
var file_feature_proto_depIdxs = []int32{
	1, // 0: QPBxFeature.geometry:type_name -> QPBxGeometry
